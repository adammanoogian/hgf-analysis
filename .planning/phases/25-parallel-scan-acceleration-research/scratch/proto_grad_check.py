...
Usage
-----
    python .planning/phases/25-parallel-scan-acceleration-research/\
        scratch/proto_grad_check.py
"""
...
# Paths
# ---------------------------------------------------------------------------
_PHASE_DIR = Path(__file__).resolve().parent.parent
_RESULTS_DIR = _PHASE_DIR / "results"
