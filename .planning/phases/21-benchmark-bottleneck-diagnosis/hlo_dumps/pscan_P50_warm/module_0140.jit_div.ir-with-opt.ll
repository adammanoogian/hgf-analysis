...
define void @loop_divide_fusion(ptr noalias nocapture readonly align 16 dereferenceable(384) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg2) local_unnamed_addr #0 {
entry:
