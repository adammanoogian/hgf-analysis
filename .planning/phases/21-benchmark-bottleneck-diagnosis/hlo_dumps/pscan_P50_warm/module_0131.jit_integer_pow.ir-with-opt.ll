...
define void @wrapped_multiply(ptr noalias nocapture readonly align 16 dereferenceable(384) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg1) local_unnamed_addr #0 {
entry:
