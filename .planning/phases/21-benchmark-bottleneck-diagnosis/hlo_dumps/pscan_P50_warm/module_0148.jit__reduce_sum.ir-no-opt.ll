...
is_full_tile-after:                               ; preds = %loop2.loop_exit2, %loop2.loop_exit
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer12)
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane13, ptr %return_buffer15)
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane16, ptr %return_buffer18)
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane19, ptr %return_buffer21)
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane22, ptr %return_buffer24)
...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body4
  ...
  call void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer10)
...
define internal void @region_0_3_5596c2bbad80_1f7761272601e6ea(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
