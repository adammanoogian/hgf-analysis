...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(9216) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2) {
entry:
