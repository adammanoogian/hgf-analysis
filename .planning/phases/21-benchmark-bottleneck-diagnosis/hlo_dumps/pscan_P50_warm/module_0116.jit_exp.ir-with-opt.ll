...
define void @wrapped_exponential(ptr noalias nocapture readonly align 16 dereferenceable(384) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg1) local_unnamed_addr #0 {
entry:
...
!1 = !{ptr @wrapped_exponential, !"reqntidx", i32 48}
