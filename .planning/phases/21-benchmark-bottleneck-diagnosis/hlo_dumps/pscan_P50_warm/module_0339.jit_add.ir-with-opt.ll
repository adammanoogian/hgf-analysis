...
define void @wrapped_add(ptr noalias nocapture readonly align 16 dereferenceable(384) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(384) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg2) local_unnamed_addr #0 {
entry:
...
!1 = !{ptr @wrapped_add, !"reqntidx", i32 48}
