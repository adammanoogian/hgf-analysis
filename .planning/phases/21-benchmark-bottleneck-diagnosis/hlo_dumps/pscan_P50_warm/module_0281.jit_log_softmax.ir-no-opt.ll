...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_5596c70264b0_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_0.10 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  ...
  call void @region_0_6_5596c70264b0_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_6_5596c70264b0_1f7761272601e6ea(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 16 dereferenceable(147456) %arg1, ptr noalias align 16 dereferenceable(73728) %arg2, ptr noalias align 128 dereferenceable(73728) %arg3, ptr noalias align 128 dereferenceable(147456) %arg4) {
entry:
...
loop_add_fusion.in_bounds-true:                   ; preds = %entry
  ...
  %15 = fneg double %14
  %16 = getelementptr inbounds double, ptr %arg2, i32 %12
  %17 = load double, ptr %16, align 8, !invariant.load !11
  %divide.1.3 = fdiv double %15, %17
  %18 = getelementptr double, ptr %arg1, i32 %linear_index
  %19 = getelementptr inbounds double, ptr %18, i32 0
  %20 = load double, ptr %19, align 8, !invariant.load !11
  %multiply.1.3 = fmul double %divide.1.3, %20
  ...
  store double %add.3.1, ptr %22, align 8
