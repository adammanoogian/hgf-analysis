...
define void @input_concatenate_fusion(ptr noalias nocapture readonly align 16 dereferenceable(36864) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(110592) %arg1) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_select_fusion(ptr noalias nocapture readonly align 16 dereferenceable(147456) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(110592) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(24) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg3) local_unnamed_addr #0 {
entry:
  ...
  %5 = zext nneg i16 %3 to i64
  %6 = zext nneg i16 %.decomposed to i64
  %7 = getelementptr inbounds [48 x [192 x [1 x [3 x i32]]]], ptr addrspace(1) %arg114, i64 0, i64 %5, i64 %6, i64 0, i64 0
  ...
  %32 = tail call i32 @llvm.umin.i32(i32 %narrow, i32 47)
  ...
  %38 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr addrspace(1) %arg012, i64 0, i64 %35, i64 %36, i64 %37
