...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(384) %arg0, ptr noalias align 128 dereferenceable(768) %arg1) {
entry:
...
wrapped_broadcast.in_bounds-true:                 ; preds = %entry
  %7 = getelementptr inbounds [48 x double], ptr %arg0, i32 0, i32 %row_index
