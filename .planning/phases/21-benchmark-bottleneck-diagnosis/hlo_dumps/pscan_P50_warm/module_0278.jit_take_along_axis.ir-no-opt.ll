...
define void @loop_broadcast_fusion(ptr noalias align 128 dereferenceable(147456) %arg0) {
entry:
...
define void @input_scatter_fusion(ptr noalias align 128 dereferenceable(147456) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 16 dereferenceable(110592) %arg2) {
entry:
...
scatter.3.1.in_bounds-true:                       ; preds = %entry
  ...
  %14 = udiv i32 %12, 192
  %15 = udiv i32 %14, 48
  %param_2.2 = getelementptr inbounds [48 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %14, i32 %13, i32 0, i32 0
  %param_2.21 = load i32, ptr %param_2.2, align 4, !invariant.load !8
  %16 = add i32 %8, %param_2.21
  %17 = icmp ult i32 %param_2.21, 48
  %18 = and i1 true, %17
  ...
  %22 = udiv i32 %20, 192
  %23 = udiv i32 %22, 48
  %param_2.22 = getelementptr inbounds [48 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %22, i32 %21, i32 0, i32 1
  ...
  %30 = udiv i32 %28, 192
  %31 = udiv i32 %30, 48
  %param_2.24 = getelementptr inbounds [48 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %30, i32 %29, i32 0, i32 2
...
scatter.in_bounds-true:                           ; preds = %scatter.3.1.in_bounds-true
  %35 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %16, i32 %24, i32 %32
