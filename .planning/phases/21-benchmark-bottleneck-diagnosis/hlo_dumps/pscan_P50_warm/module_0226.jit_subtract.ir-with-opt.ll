...
define void @wrapped_subtract(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %subtract.1.1 = fsub double %5, %7
  %8 = getelementptr double, ptr addrspace(1) %arg25, i64 %3
  store double %subtract.1.1, ptr addrspace(1) %8, align 8
  ret void
}
