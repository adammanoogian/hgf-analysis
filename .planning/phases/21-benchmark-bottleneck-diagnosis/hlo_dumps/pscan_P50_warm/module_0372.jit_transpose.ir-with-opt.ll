...
define void @wrapped_transpose(ptr noalias nocapture readonly align 16 dereferenceable(7680) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(7680) %arg1) local_unnamed_addr #0 {
entry:
...
wrapped_transpose.in_bounds-true:                 ; preds = %entry
  %.cmp = icmp ugt i32 %linear_index, 479
  ...
  %.cmp1 = icmp ult i32 %linear_index, 480
  ...
  %10 = getelementptr inbounds [10 x [2 x [48 x double]]], ptr addrspace(1) %arg04, i64 0, i64 %7, i64 %8, i64 %9
