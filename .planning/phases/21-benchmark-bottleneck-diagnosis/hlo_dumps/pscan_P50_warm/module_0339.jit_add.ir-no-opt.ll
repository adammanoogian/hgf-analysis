...
define void @wrapped_add(ptr noalias align 16 dereferenceable(384) %arg0, ptr noalias align 16 dereferenceable(384) %arg1, ptr noalias align 128 dereferenceable(384) %arg2) {
entry:
