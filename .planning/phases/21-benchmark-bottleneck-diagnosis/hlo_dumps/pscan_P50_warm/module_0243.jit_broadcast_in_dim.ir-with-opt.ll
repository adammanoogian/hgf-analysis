...
define void @wrapped_broadcast(ptr noalias nocapture readonly align 16 dereferenceable(8) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %3 = load double, ptr addrspace(1) %arg01, align 16, !invariant.load !5
  %4 = zext nneg i32 %linear_index to i64
  %5 = getelementptr double, ptr addrspace(1) %arg13, i64 %4
  store double %3, ptr addrspace(1) %5, align 8
  ret void
}
