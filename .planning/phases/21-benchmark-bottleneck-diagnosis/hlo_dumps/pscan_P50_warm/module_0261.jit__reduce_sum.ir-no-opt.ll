...
define void @input_reduce_fusion(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 128 dereferenceable(384) %arg1) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer20)
  ...
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane21, ptr %return_buffer23)
  ...
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane24, ptr %return_buffer26)
  ...
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane27, ptr %return_buffer29)
  ...
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane30, ptr %return_buffer32)
...
loop3.loop_body:                                  ; preds = %loop3.loop_header
  ...
  %param_0 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %82, i32 %79
  %param_03 = load double, ptr %param_0, align 8, !invariant.load !7
  store double %param_03, ptr %reduction_input_address, align 8
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
loop3.loop_body12:                                ; preds = %loop3.loop_header11
  ...
  %param_016 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %101, i32 %98
  %param_017 = load double, ptr %param_016, align 8, !invariant.load !7
  store double %param_017, ptr %reduction_input_address, align 8
  call void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer18)
...
intra_warp_reduce_write-true:                     ; preds = %thread_in_bounds-true
  ...
  %109 = getelementptr inbounds [8 x [1 x double]], ptr addrspace(3) @shared_cache, i32 0, i32 %thread.id.1, i32 %67
...
inter_warp_reduce-true:                           ; preds = %intra_warp_reduce_write-after
  %111 = getelementptr inbounds [8 x [1 x double]], ptr addrspace(3) @shared_cache, i32 0, i32 %thread.id.1, i32 %lane_id
...
reduction_write_output-true:                      ; preds = %inter_warp_reduce-true
  ...
  %output_element_address = getelementptr inbounds [48 x double], ptr %arg1, i32 0, i32 %116
...
define internal void @region_0_3_5596c6987f40_1f7761272601e6ea(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
