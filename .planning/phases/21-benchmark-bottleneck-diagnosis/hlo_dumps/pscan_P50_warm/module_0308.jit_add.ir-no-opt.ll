...
define void @wrapped_add(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2) {
entry:
  ...
  br i1 %6, label %wrapped_add.in_bounds-true, label %wrapped_add.in_bounds-after
