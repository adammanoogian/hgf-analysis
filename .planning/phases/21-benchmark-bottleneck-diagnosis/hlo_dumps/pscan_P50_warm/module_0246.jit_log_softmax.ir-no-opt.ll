...
define void @input_reduce_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 128 dereferenceable(73728) %arg1) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_5596c6467a30_81d32ca0e4beb1aa(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_0.15 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  ...
  call void @region_0_6_5596c6467a30_81d32ca0e4beb1aa(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
reduction_write_output-true:                      ; preds = %thread_in_bounds-true
  ...
  %44 = udiv i32 %42, 192
  %45 = udiv i32 %44, 48
  %output_element_address = getelementptr inbounds [48 x [192 x double]], ptr %arg1, i32 0, i32 %44, i32 %43
...
define internal void @region_0_6_5596c6467a30_81d32ca0e4beb1aa(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @input_exponential_reduce_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 128 dereferenceable(73728) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2, ptr noalias align 128 dereferenceable(147456) %arg3) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  %20 = bitcast i64 %19 to double
  store double %20, ptr %result_from_other_lane, align 8
  call void @region_1_18_5596c64735c0_1f7761272601e6ea(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer10)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %35 = mul nuw nsw i32 %24, 1
  %36 = add nuw nsw i32 0, %35
  %param_0.17 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  %param_0.172 = load double, ptr %param_0.17, align 8, !invariant.load !13
  %param_1.14 = getelementptr inbounds [48 x [192 x double]], ptr %arg1, i32 0, i32 %33, i32 %32
  ...
  call void @region_1_18_5596c64735c0_1f7761272601e6ea(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
  ...
  %param_0.174 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %45, i32 %44, i32 %40
  %param_0.175 = load double, ptr %param_0.174, align 8, !invariant.load !13
  %param_1.146 = getelementptr inbounds [48 x [192 x double]], ptr %arg1, i32 0, i32 %45, i32 %44
  ...
  %60 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg3, i32 0, i32 %56, i32 %55, i32 %51
...
reduction_write_output-true:                      ; preds = %thread_in_bounds-true
  ...
  %67 = udiv i32 %65, 192
  %68 = udiv i32 %67, 48
  %output_element_address = getelementptr inbounds [48 x [192 x double]], ptr %arg2, i32 0, i32 %67, i32 %66
  %output = load double, ptr %partial_reduction_result, align 8
  store double %output, ptr %output_element_address, align 8
  br label %reduction_write_output-after
}
...
define internal void @region_1_18_5596c64735c0_1f7761272601e6ea(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
  %2 = alloca double, align 8
...
define void @loop_subtract_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 128 dereferenceable(73728) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2, ptr noalias align 128 dereferenceable(147456) %arg3) {
entry:
