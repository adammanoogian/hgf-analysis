...
reduce.4.inner.loop_body.reduction_dim.2:         ; preds = %reduce.4.inner.loop_header.reduction_dim.2
  ...
  call void @region_0_37_5596c66b9440_8513c7e870a962f8(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
...
define internal void @region_0_37_5596c66b9440_8513c7e870a962f8(ptr dereferenceable(1) %0, ptr dereferenceable(1) %1, ptr dereferenceable(1) %output_arg) {
entry:
  %2 = alloca i8, align 1
