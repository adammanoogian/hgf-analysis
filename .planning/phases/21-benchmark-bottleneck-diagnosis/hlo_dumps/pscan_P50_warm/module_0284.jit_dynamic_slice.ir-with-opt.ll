...
define void @loop_dynamic_slice_fusion(ptr noalias nocapture readonly align 16 dereferenceable(147456) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %10 = zext i1 %7 to i64
  %11 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr addrspace(1) %arg04, i64 0, i64 %8, i64 %9, i64 %10
