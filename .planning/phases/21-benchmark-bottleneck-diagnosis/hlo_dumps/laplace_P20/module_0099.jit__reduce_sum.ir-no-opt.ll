...
reduce.7.1.inner.loop_body.reduction_dim.0:       ; preds = %reduce.7.1.inner.loop_header.reduction_dim.0
  ...
  call void @region_0_3_5600f311d2c0_198d40d801a8e3c1(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
...
define internal void @region_0_3_5600f311d2c0_198d40d801a8e3c1(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
