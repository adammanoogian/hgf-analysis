...
define void @wrapped_convert(ptr noalias nocapture readonly align 16 dereferenceable(15360) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(30720) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %6 = getelementptr float, ptr addrspace(1) %arg01, i64 %4
...
wrapped_convert.in_bounds-true:                   ; preds = %entry
  %7 = load float, ptr addrspace(1) %6, align 4, !invariant.load !5
