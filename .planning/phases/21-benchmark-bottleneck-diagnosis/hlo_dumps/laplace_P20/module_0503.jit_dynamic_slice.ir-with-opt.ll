...
entry:
  ...
  %5 = load i64, ptr addrspace(1) %arg17, align 16, !invariant.load !5
  %6 = trunc i64 %5 to i32
  %7 = icmp sgt i32 %6, 0
  %8 = zext nneg i16 %3 to i64
  %9 = zext nneg i16 %.decomposed to i64
  %10 = zext i1 %7 to i64
  %11 = getelementptr inbounds [1 x [20 x [192 x [2 x double]]]], ptr addrspace(1) %arg05, i64 0, i64 0, i64 %8, i64 %9, i64 %10
  %12 = load double, ptr addrspace(1) %11, align 8, !invariant.load !5
  %13 = zext nneg i32 %linear_index to i64
  %14 = getelementptr double, ptr addrspace(1) %arg29, i64 %13
