...
define void @wrapped_concatenate(ptr noalias nocapture readonly align 16 dereferenceable(3686400) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(3686400) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(7372800) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %3 = udiv i32 %linear_index, 192
  %4 = mul i32 %3, 192
  %.decomposed = sub i32 %linear_index, %4
  %.lhs.trunc = trunc nuw nsw i32 %3 to i16
  %5 = urem i16 %.lhs.trunc, 20
  %.lhs.trunc6 = trunc nuw nsw i32 %0 to i16
  %6 = udiv i16 %.lhs.trunc6, 30
  %7 = zext nneg i32 %linear_index to i64
  %8 = getelementptr double, ptr addrspace(1) %arg08, i64 %7
  %9 = load double, ptr addrspace(1) %8, align 8, !invariant.load !5
  %10 = zext nneg i16 %6 to i64
  %11 = zext nneg i16 %5 to i64
  %12 = zext nneg i32 %.decomposed to i64
  %13 = getelementptr inbounds [120 x [20 x [192 x [2 x double]]]], ptr addrspace(1) %arg212, i64 0, i64 %10, i64 %11, i64 %12, i64 0
  %14 = getelementptr double, ptr addrspace(1) %arg110, i64 %7
