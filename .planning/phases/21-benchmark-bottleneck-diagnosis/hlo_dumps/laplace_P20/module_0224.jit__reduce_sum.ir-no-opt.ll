...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(160) %arg0, ptr noalias align 128 dereferenceable(30720) %arg1) {
entry:
...
wrapped_broadcast.in_bounds-true:                 ; preds = %entry
  %7 = getelementptr inbounds [20 x double], ptr %arg0, i32 0, i32 %5
