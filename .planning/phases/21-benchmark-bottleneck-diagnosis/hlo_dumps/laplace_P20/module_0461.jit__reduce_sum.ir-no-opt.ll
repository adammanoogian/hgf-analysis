...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer20)
  ...
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %result_from_other_lane21, ptr %return_buffer23)
  ...
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %result_from_other_lane24, ptr %return_buffer26)
  ...
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %result_from_other_lane27, ptr %return_buffer29)
  ...
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %result_from_other_lane30, ptr %return_buffer32)
...
loop3.loop_body:                                  ; preds = %loop3.loop_header
  ...
  %param_03 = load double, ptr %param_0, align 8, !invariant.load !9
  store double %param_03, ptr %reduction_input_address, align 8
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
loop3.loop_body12:                                ; preds = %loop3.loop_header11
  ...
  %param_017 = load double, ptr %param_016, align 8, !invariant.load !9
  store double %param_017, ptr %reduction_input_address, align 8
  call void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer18)
...
define internal void @region_0_4_56010839cb60_198d40d801a8e3c1(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @input_reduce_fusion_1(ptr noalias align 16 dereferenceable(3686400) %arg0, ptr noalias align 128 dereferenceable(19200) %arg1) {
entry:
  %initial_value_addr = alloca double, align 8
  %return_buffer32 = alloca double, align 8
  %result_from_other_lane30 = alloca double, align 8
...
loop3.loop_body:                                  ; preds = %loop3.loop_header
  ...
  %param_0.1 = getelementptr inbounds [120 x [20 x [192 x double]]], ptr %arg0, i32 0, i32 %84, i32 %83, i32 %79
  %param_0.13 = load double, ptr %param_0.1, align 8, !invariant.load !9
...
loop3.loop_body12:                                ; preds = %loop3.loop_header11
  ...
  %param_0.116 = getelementptr inbounds [120 x [20 x [192 x double]]], ptr %arg0, i32 0, i32 %105, i32 %104, i32 %100
  %param_0.117 = load double, ptr %param_0.116, align 8, !invariant.load !9
