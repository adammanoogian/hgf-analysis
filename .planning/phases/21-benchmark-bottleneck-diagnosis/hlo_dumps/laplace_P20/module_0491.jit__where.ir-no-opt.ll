...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(30720) %arg0, ptr noalias align 16 dereferenceable(3840) %arg1, ptr noalias align 128 dereferenceable(30720) %arg2) {
entry:
...
loop_select_fusion.in_bounds-true:                ; preds = %entry
  %9 = getelementptr i8, ptr %arg1, i32 %linear_index
  %10 = getelementptr inbounds i8, ptr %9, i32 0
  %11 = load i8, ptr %10, align 1, !invariant.load !4
  ...
  %16 = select i1 %15, double %14, double %constant_3_1
