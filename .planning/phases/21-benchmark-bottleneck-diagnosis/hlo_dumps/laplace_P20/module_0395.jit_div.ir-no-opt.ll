...
define void @loop_divide_fusion(ptr noalias align 16 dereferenceable(19200) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(19200) %arg2) {
entry:
