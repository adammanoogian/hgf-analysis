...
wrapped_pad.in_bounds-true:                       ; preds = %entry
  ...
  %6 = icmp ugt i16 %.decomposed, 99
  %7 = zext nneg i16 %4 to i64
  %8 = getelementptr [120 x [1 x [20 x double]]], ptr addrspace(1) %arg013, i64 0, i64 %7, i64 0, i64 %.zext12
  %9 = getelementptr inbounds i8, ptr addrspace(1) %8, i64 -800
