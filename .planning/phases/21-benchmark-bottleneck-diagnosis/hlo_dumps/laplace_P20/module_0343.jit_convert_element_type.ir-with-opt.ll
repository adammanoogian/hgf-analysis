...
define void @wrapped_convert(ptr noalias nocapture readonly align 16 dereferenceable(14400) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(115200) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %6 = getelementptr i8, ptr addrspace(1) %arg01, i64 %4
...
wrapped_convert.in_bounds-true:                   ; preds = %entry
  %7 = load i8, ptr addrspace(1) %6, align 1, !invariant.load !5
