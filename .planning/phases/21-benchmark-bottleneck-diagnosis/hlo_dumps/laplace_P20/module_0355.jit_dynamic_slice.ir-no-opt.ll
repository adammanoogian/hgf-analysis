...
define void @wrapped_dynamic_slice(ptr noalias align 16 dereferenceable(960) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(160) %arg2) {
entry:
...
wrapped_dynamic-slice.in_bounds-true:             ; preds = %entry
  ...
  %9 = icmp sle i32 100, %8
  %dynamic-slice.1.1.start_idx0 = select i1 %9, i32 100, i32 %8
  %10 = add i32 %dynamic-slice.1.1.start_idx0, %3
  %11 = getelementptr inbounds [120 x double], ptr %arg0, i32 0, i32 %10
