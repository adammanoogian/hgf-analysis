...
wrapped_pad.in_bounds-true:                       ; preds = %entry
  ...
  %5 = getelementptr double, ptr addrspace(1) %arg217, i64 %4
  %.lhs.trunc = trunc nuw nsw i32 %linear_index to i16
  %6 = udiv i16 %.lhs.trunc, 120
  %7 = mul i16 %6, 120
  %.decomposed = sub i16 %.lhs.trunc, %7
  %8 = icmp ult i16 %.decomposed, 20
  %9 = zext nneg i16 %6 to i64
  %10 = zext nneg i16 %.decomposed to i64
  %11 = getelementptr inbounds [120 x [1 x [20 x double]]], ptr addrspace(1) %arg013, i64 0, i64 %9, i64 0, i64 %10
  %pad_result_addr.0.in = select i1 %8, ptr addrspace(1) %11, ptr addrspace(1) %arg115
