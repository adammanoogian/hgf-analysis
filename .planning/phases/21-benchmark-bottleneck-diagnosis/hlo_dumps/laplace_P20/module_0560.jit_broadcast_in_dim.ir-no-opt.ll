...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 128 dereferenceable(160) %arg1) {
entry:
  ...
  %8 = icmp ult i32 %linear_index, 20
