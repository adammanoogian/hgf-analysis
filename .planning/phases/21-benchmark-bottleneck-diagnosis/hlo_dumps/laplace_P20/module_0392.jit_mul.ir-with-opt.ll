...
define void @loop_multiply_fusion(ptr noalias nocapture readonly align 16 dereferenceable(19200) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(19200) %arg2) local_unnamed_addr #0 {
entry:
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %7 = load double, ptr addrspace(1) %arg13, align 16, !invariant.load !5
  %8 = load double, ptr addrspace(1) %6, align 8, !invariant.load !5
  %multiply.1.1 = fmul double %7, %8
  store double %multiply.1.1, ptr addrspace(1) %5, align 8
