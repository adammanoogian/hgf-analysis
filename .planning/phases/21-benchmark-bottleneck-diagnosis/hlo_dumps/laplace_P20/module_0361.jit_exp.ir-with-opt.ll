...
define void @wrapped_exponential(ptr noalias nocapture readonly align 16 dereferenceable(160) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(160) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %3 = load double, ptr addrspace(1) %2, align 8, !invariant.load !9
  %4 = tail call double @llvm.fma.f64(double %3, double 0x3FF71547652B82FE, double 0x4338000000000000)
  %5 = tail call i32 @llvm.nvvm.d2i.lo(double %4) #3
  %6 = tail call double @llvm.nvvm.add.rn.d(double %4, double 0xC338000000000000) #3
  ...
  %20 = tail call i32 @llvm.nvvm.d2i.lo(double %19) #3
  %21 = tail call i32 @llvm.nvvm.d2i.hi(double %19) #3
  %22 = shl i32 %5, 20
  %23 = add i32 %21, %22
  %24 = tail call double @llvm.nvvm.lohi.i2d(i32 %20, i32 %23) #3
  %25 = tail call i32 @llvm.nvvm.d2i.hi(double %3) #3
  %26 = bitcast i32 %25 to float
  %27 = tail call float @llvm.nvvm.fabs.f(float %26) #3
...
__internal_fast_icmp_abs_lt.exit.i:               ; preds = %entry
  %29 = fcmp olt double %3, 0.000000e+00
  %30 = fadd double %3, 0x7FF0000000000000
...
32:                                               ; preds = %__internal_fast_icmp_abs_lt.exit.i
  ...
  %34 = shl i32 %33, 20
  %35 = add i32 %21, %34
  %36 = tail call double @llvm.nvvm.lohi.i2d(i32 %20, i32 %35) #3
  %37 = sub nsw i32 %5, %33
  %38 = shl i32 %37, 20
  %39 = add nsw i32 %38, 1072693248
  %40 = tail call double @llvm.nvvm.lohi.i2d(i32 0, i32 %39) #3
...
__nv_exp.exit:                                    ; preds = %entry, %__internal_fast_icmp_abs_lt.exit.i, %32
  ...
  %42 = getelementptr double, ptr addrspace(1) %arg13, i64 %1
  store double %z.2.i, ptr addrspace(1) %42, align 8
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_multiply_fusion(ptr noalias nocapture readonly align 16 dereferenceable(19200) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(160) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(19200) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %3 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.y(), !range !11
  ...
  %8 = getelementptr double, ptr addrspace(1) %arg25, i64 %7
  %9 = zext nneg i32 %1 to i64
  %10 = getelementptr inbounds [20 x double], ptr addrspace(1) %arg13, i64 0, i64 %9
  %11 = getelementptr double, ptr addrspace(1) %arg01, i64 %7
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %12 = load double, ptr addrspace(1) %11, align 8, !invariant.load !9
  %13 = load double, ptr addrspace(1) %10, align 8, !invariant.load !9
  %multiply.1.1 = fmul double %12, %13
