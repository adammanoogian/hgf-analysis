...
entry:
  ...
  %4 = getelementptr inbounds [1 x [20 x double]], ptr addrspace(1) %arg06, i64 0, i64 0, i64 %3
  %pad_result_addr.0.in = select i1 %1, ptr addrspace(1) %4, ptr addrspace(1) %arg18
