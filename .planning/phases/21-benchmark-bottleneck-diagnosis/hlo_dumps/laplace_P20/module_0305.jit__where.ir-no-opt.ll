...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(160) %arg0, ptr noalias align 16 dereferenceable(160) %arg1, ptr noalias align 16 dereferenceable(1) %arg2, ptr noalias align 128 dereferenceable(160) %arg3) {
entry:
  ...
  br i1 %4, label %loop_select_fusion.in_bounds-true, label %loop_select_fusion.in_bounds-after
...
loop_select_fusion.in_bounds-true:                ; preds = %entry
  %5 = load i8, ptr %arg2, align 1, !invariant.load !4
...
!1 = !{ptr @loop_select_fusion, !"reqntidx", i32 20}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 20}
!4 = !{}
