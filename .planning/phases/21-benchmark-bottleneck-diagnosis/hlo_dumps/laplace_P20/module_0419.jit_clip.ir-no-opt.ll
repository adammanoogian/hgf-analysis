...
define void @loop_divide_minimum_fusion(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(30720) %arg1, ptr noalias align 16 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(30720) %arg3, ptr noalias align 128 dereferenceable(30720) %arg4, ptr noalias align 128 dereferenceable(30720) %arg5) {
entry:
...
define void @loop_multiply_fusion(ptr noalias align 128 dereferenceable(30720) %arg0, ptr noalias align 128 dereferenceable(30720) %arg1, ptr noalias align 16 dereferenceable(3686400) %arg2, ptr noalias align 128 dereferenceable(3686400) %arg3) {
entry:
  ...
  br i1 %23, label %loop_multiply_fusion.in_bounds-true, label %loop_multiply_fusion.in_bounds-after
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %24 = getelementptr inbounds [192 x [120 x [20 x double]]], ptr %arg2, i32 0, i32 %6, i32 %7, i32 %4
  %25 = load double, ptr %24, align 8, !invariant.load !6
  %26 = urem i32 %linear_index0, 3840
  %27 = getelementptr inbounds double, ptr %arg1, i32 %26
  %28 = load double, ptr %27, align 8, !invariant.load !6
  %multiply.4.1 = fmul double %25, %28
  %29 = urem i32 %linear_index0, 3840
  %30 = getelementptr inbounds double, ptr %arg0, i32 %29
  %31 = load double, ptr %30, align 8, !invariant.load !6
  %multiply.5.1 = fmul double %multiply.4.1, %31
  %32 = getelementptr double, ptr %arg3, i32 %linear_index_base
  %33 = getelementptr inbounds double, ptr %32, i32 0
  store double %multiply.5.1, ptr %33, align 8
  %34 = getelementptr inbounds [192 x [120 x [20 x double]]], ptr %arg2, i32 0, i32 %11, i32 %12, i32 %9
  %35 = load double, ptr %34, align 8, !invariant.load !6
  %36 = urem i32 %linear_index1, 3840
  %37 = getelementptr inbounds double, ptr %arg1, i32 %36
  %38 = load double, ptr %37, align 8, !invariant.load !6
  %multiply.4.11 = fmul double %35, %38
  %39 = urem i32 %linear_index1, 3840
  %40 = getelementptr inbounds double, ptr %arg0, i32 %39
  %41 = load double, ptr %40, align 8, !invariant.load !6
  %multiply.5.12 = fmul double %multiply.4.11, %41
  %42 = getelementptr double, ptr %arg3, i32 %linear_index_base
  %43 = getelementptr inbounds double, ptr %42, i32 1
  store double %multiply.5.12, ptr %43, align 8
  %44 = getelementptr inbounds [192 x [120 x [20 x double]]], ptr %arg2, i32 0, i32 %16, i32 %17, i32 %14
  %45 = load double, ptr %44, align 8, !invariant.load !6
  %46 = urem i32 %linear_index2, 3840
  %47 = getelementptr inbounds double, ptr %arg1, i32 %46
  %48 = load double, ptr %47, align 8, !invariant.load !6
  %multiply.4.13 = fmul double %45, %48
  %49 = urem i32 %linear_index2, 3840
  %50 = getelementptr inbounds double, ptr %arg0, i32 %49
  %51 = load double, ptr %50, align 8, !invariant.load !6
  %multiply.5.14 = fmul double %multiply.4.13, %51
  %52 = getelementptr double, ptr %arg3, i32 %linear_index_base
  %53 = getelementptr inbounds double, ptr %52, i32 2
  store double %multiply.5.14, ptr %53, align 8
  %54 = getelementptr inbounds [192 x [120 x [20 x double]]], ptr %arg2, i32 0, i32 %21, i32 %22, i32 %19
  %55 = load double, ptr %54, align 8, !invariant.load !6
  %56 = urem i32 %linear_index3, 3840
  %57 = getelementptr inbounds double, ptr %arg1, i32 %56
  %58 = load double, ptr %57, align 8, !invariant.load !6
  %multiply.4.15 = fmul double %55, %58
  %59 = urem i32 %linear_index3, 3840
  %60 = getelementptr inbounds double, ptr %arg0, i32 %59
  %61 = load double, ptr %60, align 8, !invariant.load !6
  %multiply.5.16 = fmul double %multiply.4.15, %61
  %62 = getelementptr double, ptr %arg3, i32 %linear_index_base
  %63 = getelementptr inbounds double, ptr %62, i32 3
  store double %multiply.5.16, ptr %63, align 8
