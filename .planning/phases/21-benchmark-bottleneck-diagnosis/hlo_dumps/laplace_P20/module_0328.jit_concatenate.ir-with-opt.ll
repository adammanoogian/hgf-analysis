...
define void @wrapped_concatenate(ptr noalias nocapture readonly align 16 dereferenceable(160) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(160) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(160) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(160) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(160) %arg4, ptr noalias nocapture readonly align 16 dereferenceable(160) %arg5, ptr noalias nocapture writeonly align 128 dereferenceable(960) %arg6) local_unnamed_addr #0 {
entry:
...
concatenate.pivot.20.:                            ; preds = %entry
  %2 = icmp ult i32 %0, 20
  br i1 %2, label %concatenate.1.1.merge, label %concatenate.pivot.40.
...
concatenate.1.1.merge:                            ; preds = %concatenate.pivot.20., %concatenate.pivot.100.5, %concatenate.pivot.80.4, %concatenate.pivot.60.3, %concatenate.pivot.40.2, %concatenate.pivot.20.1
