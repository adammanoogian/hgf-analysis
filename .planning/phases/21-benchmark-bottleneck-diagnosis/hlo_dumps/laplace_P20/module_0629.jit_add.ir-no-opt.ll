...
define void @wrapped_add(ptr noalias align 16 dereferenceable(960) %arg0, ptr noalias align 16 dereferenceable(960) %arg1, ptr noalias align 128 dereferenceable(960) %arg2) {
entry:
