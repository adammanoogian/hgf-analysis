...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(115200) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(115200) %arg2) {
entry:
