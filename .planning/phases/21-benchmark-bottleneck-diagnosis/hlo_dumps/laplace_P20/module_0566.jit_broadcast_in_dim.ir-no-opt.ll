...
define void @loop_broadcast_fusion(ptr noalias align 16 dereferenceable(160) %arg0, ptr noalias align 128 dereferenceable(19200) %arg1) {
entry:
  ...
  %8 = urem i32 %7, 1
  %9 = udiv i32 %linear_index0, 20
  %10 = icmp ult i32 %linear_index, 2400
...
loop_broadcast_fusion.in_bounds-true:             ; preds = %entry
  %11 = getelementptr inbounds [1 x [20 x [1 x double]]], ptr %arg0, i32 0, i32 0, i32 %6, i32 0
