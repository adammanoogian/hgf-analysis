...
define void @wrapped_concatenate(ptr noalias align 16 dereferenceable(3686400) %arg0, ptr noalias align 16 dereferenceable(3686400) %arg1, ptr noalias align 128 dereferenceable(7372800) %arg2) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !2
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !3
  %2 = mul nuw nsw i32 %0, 128
  %linear_index = add nuw nsw i32 %2, %1
  %linear_index_in_range = icmp ult i32 %linear_index, 460800
  ...
  %10 = icmp ult i32 %linear_index, 460800
...
wrapped_concatenate.in_bounds-after:              ; preds = %wrapped_concatenate.in_bounds-true, %entry
  ...
  %linear_index_in_range2 = icmp ult i32 %linear_index1, 460800
  ...
  %19 = urem i32 %18, 20
  %20 = udiv i32 %linear_index03, 3840
  %21 = icmp ult i32 %linear_index1, 460800
...
wrapped_concatenate.in_bounds-true:               ; preds = %entry
  ...
  %26 = getelementptr inbounds [120 x [20 x [192 x [2 x double]]]], ptr %arg2, i32 0, i32 %9, i32 %8, i32 %6, i32 %22
...
wrapped_concatenate.in_bounds-true4:              ; preds = %wrapped_concatenate.in_bounds-after
  ...
  %31 = getelementptr inbounds [120 x [20 x [192 x [2 x double]]]], ptr %arg2, i32 0, i32 %20, i32 %19, i32 %17, i32 %27
