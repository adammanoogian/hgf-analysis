...
loop1.loop_body.preheader:                        ; preds = %entry
  ...
  %6 = load <2 x double>, ptr addrspace(1) %param_016, align 16, !invariant.load !7
  ...
  %7 = load <2 x double>, ptr addrspace(1) %param_016.15462, align 16, !invariant.load !7
  ...
  %8 = load <2 x double>, ptr addrspace(1) %param_016.264, align 16, !invariant.load !7
...
; Function Attrs: norecurse nounwind
define void @input_reduce_fusion_1(ptr noalias nocapture readonly align 16 dereferenceable(3686400) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(19200) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %param_0.116 = getelementptr inbounds [120 x [20 x [192 x double]]], ptr addrspace(1) %arg061, i64 0, i64 %4, i64 %5, i64 %7
  %8 = load <2 x double>, ptr addrspace(1) %param_0.116, align 16, !invariant.load !7
  %param_0.11770 = extractelement <2 x double> %8, i32 0
  %param_0.117.171 = extractelement <2 x double> %8, i32 1
  %add.1.i45 = fadd double %param_0.11770, 0.000000e+00
  %add.1.i45.1 = fadd double %add.1.i45, %param_0.117.171
  %param_0.116.15266 = getelementptr inbounds i8, ptr addrspace(1) %param_0.116, i64 512
  %9 = load <2 x double>, ptr addrspace(1) %param_0.116.15266, align 16, !invariant.load !7
  %param_0.117.15372 = extractelement <2 x double> %9, i32 0
  %param_0.117.1.173 = extractelement <2 x double> %9, i32 1
  %add.1.i45.154 = fadd double %add.1.i45.1, %param_0.117.15372
  %add.1.i45.1.1 = fadd double %add.1.i45.154, %param_0.117.1.173
  %param_0.116.268 = getelementptr inbounds i8, ptr addrspace(1) %param_0.116, i64 1024
  %10 = load <2 x double>, ptr addrspace(1) %param_0.116.268, align 16, !invariant.load !7
  %param_0.117.274 = extractelement <2 x double> %10, i32 0
  %param_0.117.1.275 = extractelement <2 x double> %10, i32 1
  %add.1.i45.2 = fadd double %add.1.i45.1.1, %param_0.117.274
  %add.1.i45.1.2 = fadd double %add.1.i45.2, %param_0.117.1.275
