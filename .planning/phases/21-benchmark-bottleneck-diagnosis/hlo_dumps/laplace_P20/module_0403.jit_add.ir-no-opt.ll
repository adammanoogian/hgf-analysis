...
define void @input_slice_fusion(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 16 dereferenceable(960) %arg2, ptr noalias align 16 dereferenceable(960) %arg3, ptr noalias align 128 dereferenceable(8) %arg4, ptr noalias align 128 dereferenceable(960) %arg5) {
entry:
...
concat_index_from_operand_id1:                    ; preds = %concatenate.pivot.1.1
  ...
  %10 = sub nsw i32 %3, %9
  %11 = getelementptr inbounds [120 x double], ptr %arg2, i32 0, i32 %10
  %12 = load double, ptr %11, align 8, !invariant.load !4
  %13 = getelementptr inbounds [120 x double], ptr %arg3, i32 0, i32 %10
...
slice1-true:                                      ; preds = %slice0-after
  %25 = sub i32 %3, 1
  %26 = getelementptr inbounds [120 x double], ptr %arg5, i32 0, i32 %25
