...
define void @loop_broadcast_fusion(ptr noalias nocapture readonly align 16 dereferenceable(1536) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(30720) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %5 = getelementptr inbounds [192 x [1 x double]], ptr addrspace(1) %arg01, i64 0, i64 %4, i64 0
