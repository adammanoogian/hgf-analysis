...
define void @loop_broadcast_fusion(ptr noalias nocapture writeonly align 128 dereferenceable(61440) %arg0) local_unnamed_addr #0 {
entry:
...
define void @input_scatter_fusion(ptr noalias nocapture align 128 dereferenceable(61440) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(30720) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(46080) %arg2) local_unnamed_addr #2 {
entry:
  ...
  %param_2.2 = getelementptr inbounds [20 x [192 x [1 x [3 x i32]]]], ptr addrspace(1) %arg213, i64 0, i64 %5, i64 %6, i64 0, i64 0
  %param_2.21 = load i32, ptr addrspace(1) %param_2.2, align 4, !invariant.load !9
  %7 = icmp ult i32 %param_2.21, 20
  ...
  %17 = getelementptr inbounds [20 x [192 x [2 x [1 x double]]]], ptr addrspace(1) %arg09, i64 0, i64 %14, i64 %15, i64 %16, i64 0
