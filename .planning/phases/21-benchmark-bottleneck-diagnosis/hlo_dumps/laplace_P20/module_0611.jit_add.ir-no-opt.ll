...
define void @wrapped_add(ptr noalias align 16 dereferenceable(160) %arg0, ptr noalias align 16 dereferenceable(160) %arg1, ptr noalias align 128 dereferenceable(160) %arg2) {
entry:
...
!1 = !{ptr @wrapped_add, !"reqntidx", i32 20}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 20}
!4 = !{}
