...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(8) %arg2) {
entry:
...
loop_add_fusion.in_bounds-true:                   ; preds = %entry
  ...
  %10 = load i64, ptr %arg1, align 8, !invariant.load !3
  %11 = add i64 %9, %10
