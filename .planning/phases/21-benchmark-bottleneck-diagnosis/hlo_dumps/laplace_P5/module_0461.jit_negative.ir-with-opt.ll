...
define void @input_slice_fusion(ptr noalias nocapture readonly align 16 dereferenceable(8) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(192) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(8) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(192) %arg3) local_unnamed_addr #0 {
entry:
  ...
  %4 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg15, i64 0, i64 %3
  %.sink2 = select i1 %1, ptr addrspace(1) %arg03, ptr addrspace(1) %4
  %5 = load double, ptr addrspace(1) %.sink2, align 8, !invariant.load !4
  %6 = fneg double %5
  %7 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg39, i64 0, i64 %3
