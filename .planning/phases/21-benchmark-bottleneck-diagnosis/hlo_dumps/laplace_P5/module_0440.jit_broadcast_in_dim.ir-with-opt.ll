...
define void @loop_broadcast_fusion(ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(147456) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %5 = getelementptr inbounds double, ptr addrspace(1) %arg01, i64 %4
