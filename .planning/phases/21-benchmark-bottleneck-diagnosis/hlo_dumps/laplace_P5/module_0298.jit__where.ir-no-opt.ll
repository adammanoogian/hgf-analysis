...
define void @wrapped_select(ptr noalias align 16 dereferenceable(1) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 16 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(8) %arg3) {
entry:
...
wrapped_select.in_bounds-true:                    ; preds = %entry
  ...
  %5 = load i64, ptr %arg1, align 8, !invariant.load !3
  %6 = load i64, ptr %arg2, align 8, !invariant.load !3
  %7 = trunc i8 %4 to i1
  %8 = select i1 %7, i64 %5, i64 %6
  store i64 %8, ptr %arg3, align 8
