...
concatenate.pivot.0.:                             ; preds = %entry
  ...
  %8 = getelementptr inbounds [4 x [192 x double]], ptr addrspace(1) %arg05, i64 0, i64 %6, i64 %7
...
concatenate.pivot.768.1:                          ; preds = %entry
  ...
  %17 = getelementptr inbounds [24 x [4 x [192 x double]]], ptr addrspace(1) %arg17, i64 0, i64 %14, i64 %15, i64 %16
  br label %concatenate.merge
...
concatenate.merge:                                ; preds = %concatenate.pivot.768.1, %concatenate.pivot.0.
  ...
  %18 = icmp ult i32 %0, 6
  %19 = load double, ptr addrspace(1) %.in, align 8, !invariant.load !5
