...
define void @loop_select_fusion(ptr noalias nocapture readonly align 16 dereferenceable(80) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(80) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(1) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(80) %arg3) local_unnamed_addr #0 {
entry:
