...
define void @wrapped_exponential(ptr noalias nocapture readonly align 16 dereferenceable(32) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(32) %arg1) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_multiply_fusion(ptr noalias nocapture readonly align 16 dereferenceable(768) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(768) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %2 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !7
  ...
  %7 = getelementptr inbounds [4 x double], ptr addrspace(1) %arg13, i64 0, i64 %6
  %8 = load double, ptr addrspace(1) %7, align 8, !invariant.load !8
  %multiply.1.1 = fmul double %5, %8
  %9 = getelementptr double, ptr addrspace(1) %arg25, i64 %3
  store double %multiply.1.1, ptr addrspace(1) %9, align 8
  ret void
}
