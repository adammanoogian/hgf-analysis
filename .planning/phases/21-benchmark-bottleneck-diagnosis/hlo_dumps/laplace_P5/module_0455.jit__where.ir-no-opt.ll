...
define void @loop_select_fusion_1(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 16 dereferenceable(6144) %arg1, ptr noalias align 16 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(6144) %arg3) {
entry:
...
define void @loop_broadcast_fusion(ptr noalias align 128 dereferenceable(6144) %arg0) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !6
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !7
  %2 = mul nuw nsw i32 %0, 768
...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 16 dereferenceable(768) %arg1, ptr noalias align 128 dereferenceable(147456) %arg2) {
entry:
...
loop_select_fusion.in_bounds-true:                ; preds = %entry
  %9 = urem i32 %linear_index0, 768
  %10 = getelementptr inbounds i8, ptr %arg1, i32 %9
  %11 = load i8, ptr %10, align 1, !invariant.load !8
  ...
  %16 = select i1 %15, double %14, double %constant_5_1
