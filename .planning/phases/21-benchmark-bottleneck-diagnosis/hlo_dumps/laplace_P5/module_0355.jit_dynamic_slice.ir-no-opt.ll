...
define void @loop_dynamic_slice_fusion(ptr noalias align 16 dereferenceable(4608) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(768) %arg2) {
entry:
...
loop_dynamic_slice_fusion.in_bounds-true:         ; preds = %entry
  ...
  %15 = icmp sle i32 20, %14
  %dynamic-slice.2.1.start_idx1 = select i1 %15, i32 20, i32 %14
  %16 = add i32 %dynamic-slice.2.1.start_idx0, %5
  %17 = add i32 %dynamic-slice.2.1.start_idx1, %4
  %18 = getelementptr inbounds [24 x [24 x double]], ptr %arg0, i32 0, i32 %16, i32 %17
