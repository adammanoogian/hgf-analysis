...
define void @wrapped_multiply(ptr noalias nocapture readonly align 16 dereferenceable(32) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(32) %arg1) local_unnamed_addr #0 {
entry:
...
!1 = !{ptr @wrapped_multiply, !"reqntidx", i32 4}
