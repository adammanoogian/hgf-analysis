...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 128 dereferenceable(32) %arg1) {
entry:
  ...
  %8 = icmp ult i32 %linear_index, 4
  br i1 %8, label %wrapped_broadcast.in_bounds-true, label %wrapped_broadcast.in_bounds-after
...
wrapped_broadcast.in_bounds-true:                 ; preds = %entry
  %9 = load double, ptr %arg0, align 8, !invariant.load !4
