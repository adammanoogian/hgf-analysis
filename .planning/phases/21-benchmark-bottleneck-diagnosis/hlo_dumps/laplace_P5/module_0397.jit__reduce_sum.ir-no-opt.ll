...
x_in_tile-after:                                  ; preds = %x_in_tile-true, %loop2.loop_body
  br label %loop2.loop_header, !llvm.loop !6
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
  ...
  call void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr %partial_reduction_result, ptr %result_from_other_lane5, ptr %return_buffer7)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_02 = load double, ptr %param_0, align 8, !invariant.load !10
  store double %param_02, ptr %reduction_input_address, align 8
  call void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @input_reduce_fusion_1(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 128 dereferenceable(192) %arg1) {
entry:
  %return_buffer7 = alloca double, align 8
  %result_from_other_lane5 = alloca double, align 8
  %return_buffer4 = alloca double, align 8
...
loop1.loop_header:                                ; preds = %loop2.loop_exit, %reduce-group-0-true
  %loop1.indvar = load i32, ptr %loop1.invar_address, align 4
  %7 = icmp uge i32 %loop1.indvar, 24
  br i1 %7, label %loop1.loop_exit, label %loop1.loop_body

loop1.loop_body:                                  ; preds = %loop1.loop_header
  %invar.inc = add nuw nsw i32 %loop1.indvar, 24
  store i32 %invar.inc, ptr %loop1.invar_address, align 4
  store i32 0, ptr %loop2.invar_address, align 4
  br label %loop2.loop_header
...
loop2.loop_exit:                                  ; preds = %loop2.loop_header
  br label %loop1.loop_header, !llvm.loop !13
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  %14 = call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %13, i32 2, i32 31)
  %15 = insertelement <2 x i32> %12, i32 %14, i64 0
  %16 = extractelement <2 x i32> %15, i64 1
  %17 = call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %16, i32 2, i32 31)
  ...
  %partial_reduction_result6 = load double, ptr %partial_reduction_result, align 8
  %22 = bitcast double %partial_reduction_result6 to i64
  %23 = bitcast i64 %22 to <2 x i32>
  %24 = extractelement <2 x i32> %23, i64 0
  %25 = call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %24, i32 1, i32 31)
  %26 = insertelement <2 x i32> %23, i32 %25, i64 0
  %27 = extractelement <2 x i32> %26, i64 1
  %28 = call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %27, i32 1, i32 31)
  %29 = insertelement <2 x i32> %26, i32 %28, i64 1
  %30 = bitcast <2 x i32> %29 to i64
  %31 = bitcast i64 %30 to double
  store double %31, ptr %result_from_other_lane5, align 8
  call void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr %partial_reduction_result, ptr %result_from_other_lane5, ptr %return_buffer7)
  %32 = load double, ptr %return_buffer7, align 8
  store double %32, ptr %partial_reduction_result, align 8
  %33 = udiv i32 %thread.id.2, 32
  %34 = icmp ult i32 %thread.id.1, 24
  br i1 %34, label %thread_in_bounds-true, label %thread_in_bounds-after

thread_in_bounds-after:                           ; preds = %reduction_write_output-after, %loop1.loop_exit
  br label %reduce-group-0-after

x_in_tile-true:                                   ; preds = %loop2.loop_body
  %35 = add i32 %tile_origin.0, 0
  %36 = add i32 %tile_origin.1, %loop1.indvar
  %37 = add i32 %tile_origin.2, %9
  %param_0.1 = getelementptr inbounds [24 x [4 x double]], ptr %arg0, i32 0, i32 %36, i32 %37
  %param_0.12 = load double, ptr %param_0.1, align 8, !invariant.load !10
  store double %param_0.12, ptr %reduction_input_address, align 8
  call void @region_0_4_55fe6d1bea60_79b0d34134220a8b(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
reduction_write_output-true:                      ; preds = %thread_in_bounds-true
  %41 = add i32 %tile_origin.1, %thread.id.1
  %output_element_address = getelementptr inbounds [24 x double], ptr %arg1, i32 0, i32 %41
  %output = load double, ptr %partial_reduction_result, align 8
...
!3 = !{ptr @input_reduce_fusion_1, !"reqntidx", i32 96}
!4 = !{i32 0, i32 1}
!5 = !{i32 0, i32 32}
!6 = distinct !{!6, !7, !8}
