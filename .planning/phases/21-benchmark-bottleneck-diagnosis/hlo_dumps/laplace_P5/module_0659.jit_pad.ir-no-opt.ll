...
define void @wrapped_pad(ptr noalias align 16 dereferenceable(32) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(192) %arg2) {
entry:
...
in_bounds-true:                                   ; preds = %wrapped_pad.in_bounds-true
  %22 = getelementptr inbounds [1 x [4 x double]], ptr %arg0, i32 0, i32 0, i32 %17
