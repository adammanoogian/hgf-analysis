...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %9 = getelementptr inbounds [1 x [4 x [192 x double]]], ptr %arg1, i32 0, i32 0, i32 %4, i32 %6
  %10 = load double, ptr %9, align 8, !invariant.load !6
  %11 = getelementptr inbounds [4 x [192 x double]], ptr %arg0, i32 0, i32 %4, i32 %6
...
define void @loop_multiply_fusion_1(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 16 dereferenceable(6144) %arg1, ptr noalias align 128 dereferenceable(147456) %arg2) {
entry:
...
loop_multiply_fusion.1.in_bounds-true:            ; preds = %entry
  %11 = getelementptr inbounds [24 x [1 x [4 x [192 x double]]]], ptr %arg0, i32 0, i32 %9, i32 0, i32 %4, i32 %6
  %12 = load double, ptr %11, align 8, !invariant.load !6
  %13 = urem i32 %linear_index0, 768
  %14 = getelementptr inbounds [4 x [192 x double]], ptr %arg1, i32 0, i32 %4, i32 %6
  %15 = load double, ptr %14, align 8, !invariant.load !6
  %multiply.3.1 = fmul double %12, %15
  %16 = getelementptr double, ptr %arg2, i32 %linear_index
  %17 = getelementptr inbounds double, ptr %16, i32 0
  store double %multiply.3.1, ptr %17, align 8
