...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(4608) %arg0, ptr noalias align 128 dereferenceable(4608) %arg1) {
entry:
...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  %param_0 = getelementptr inbounds [24 x [24 x double]], ptr %arg0, i32 0, i32 %11, i32 %12
...
loop2.loop_body11:                                ; preds = %loop2.loop_header10
  ...
  %23 = getelementptr inbounds [24 x [24 x double]], ptr %arg1, i32 0, i32 %18, i32 %19
