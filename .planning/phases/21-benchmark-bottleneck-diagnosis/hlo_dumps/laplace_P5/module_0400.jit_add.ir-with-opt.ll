...
define void @input_slice_fusion(ptr noalias nocapture readonly align 16 dereferenceable(8) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(8) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(192) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(192) %arg3, ptr noalias nocapture writeonly align 128 dereferenceable(8) %arg4, ptr noalias nocapture writeonly align 128 dereferenceable(192) %arg5) local_unnamed_addr #0 {
entry:
  ...
  %4 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg28, i64 0, i64 %3
  %5 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg310, i64 0, i64 %3
  ...
  %7 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg514, i64 0, i64 %3
