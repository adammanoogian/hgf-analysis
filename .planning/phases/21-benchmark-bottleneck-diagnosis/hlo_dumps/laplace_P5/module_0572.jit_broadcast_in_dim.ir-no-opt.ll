...
define void @loop_broadcast_fusion(ptr noalias align 16 dereferenceable(32) %arg0, ptr noalias align 128 dereferenceable(768) %arg1) {
entry:
...
loop_broadcast_fusion.in_bounds-true:             ; preds = %entry
  %11 = getelementptr inbounds [1 x [4 x [1 x double]]], ptr %arg0, i32 0, i32 0, i32 %6, i32 0
