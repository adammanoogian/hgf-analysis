...
entry:
  ...
  %4 = load <2 x double>, ptr addrspace(1) %param_016, align 16, !invariant.load !4
  ...
  %5 = load <2 x double>, ptr addrspace(1) %param_016.15260, align 16, !invariant.load !4
  ...
  %6 = load <2 x double>, ptr addrspace(1) %param_016.262, align 16, !invariant.load !4
