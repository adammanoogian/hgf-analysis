...
define void @input_concatenate_fusion(ptr noalias align 16 dereferenceable(3072) %arg0, ptr noalias align 128 dereferenceable(9216) %arg1) {
entry:
...
input_concatenate_fusion.in_bounds-true:          ; preds = %entry
  ...
  %36 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %9, i32 %8, i32 0, i32 %33
...
input_concatenate_fusion.in_bounds-true4:         ; preds = %input_concatenate_fusion.in_bounds-after
  ...
  %40 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %20, i32 %19, i32 0, i32 %37
...
input_concatenate_fusion.in_bounds-true9:         ; preds = %input_concatenate_fusion.in_bounds-after5
  ...
  %50 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %31, i32 %30, i32 0, i32 %41
...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(12288) %arg0, ptr noalias align 128 dereferenceable(9216) %arg1, ptr noalias align 128 dereferenceable(24) %arg2, ptr noalias align 128 dereferenceable(6144) %arg3) {
entry:
...
reduce.4.inner.loop_body.reduction_dim.2:         ; preds = %reduce.4.inner.loop_header.reduction_dim.2
  ...
  %11 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %7, i32 %6, i32 0, i32 %reduce.4.inner.indvar.reduction_dim.2
  ...
  call void @region_0_43_55fe6aabc4e0_d0fec12da5b9a514(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
...
reduce.4.inner.loop_exit.reduction_dim.2:         ; preds = %reduce.4.inner.loop_header.reduction_dim.2
  ...
  %34 = udiv i32 %32, 192
  %35 = udiv i32 %34, 4
  %36 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %34, i32 %33, i32 0, i32 0
  %37 = load i32, ptr %36, align 4, !invariant.load !8
  %38 = sext i32 %37 to i64
  %39 = icmp sge i64 0, %38
  %40 = select i1 %39, i64 0, i64 %38
  %41 = icmp sle i64 3, %40
  %42 = select i1 %41, i64 3, i64 %40
  ...
  %48 = udiv i32 %46, 192
  %49 = udiv i32 %48, 4
  %50 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %48, i32 %47, i32 0, i32 1
  ...
  %62 = udiv i32 %60, 192
  %63 = udiv i32 %62, 4
  %64 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg1, i32 0, i32 %62, i32 %61, i32 0, i32 2
  ...
  %72 = add i32 0, %71
  %73 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %44, i32 %58, i32 %72
...
define internal void @region_0_43_55fe6aabc4e0_d0fec12da5b9a514(ptr dereferenceable(1) %0, ptr dereferenceable(1) %1, ptr dereferenceable(1) %output_arg) {
entry:
  %2 = alloca i8, align 1
...
define void @loop_select_fusion_1(ptr noalias align 128 dereferenceable(9216) %arg0, ptr noalias align 16 dereferenceable(294912) %arg1, ptr noalias align 128 dereferenceable(24) %arg2, ptr noalias align 128 dereferenceable(147456) %arg3) {
entry:
  %return_buffer = alloca i8, align 1
  %parameter_buffer1 = alloca i8, align 1
  %parameter_buffer = alloca i8, align 1
  ...
  br i1 %10, label %loop_select_fusion.1.in_bounds-true, label %loop_select_fusion.1.in_bounds-after

loop_select_fusion.1.in_bounds-after:             ; preds = %reduce.6.inner.loop_exit.reduction_dim.2, %entry
  ret void
...
reduce.6.inner.loop_header.reduction_dim.2:       ; preds = %reduce.6.inner.loop_body.reduction_dim.2, %loop_select_fusion.1.in_bounds-true
  ...
  %12 = icmp uge i32 %reduce.6.inner.indvar.reduction_dim.2, 3
  br i1 %12, label %reduce.6.inner.loop_exit.reduction_dim.2, label %reduce.6.inner.loop_body.reduction_dim.2

reduce.6.inner.loop_body.reduction_dim.2:         ; preds = %reduce.6.inner.loop_header.reduction_dim.2
  %13 = load i8, ptr %accumulator_0, align 1
  %14 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg0, i32 0, i32 %8, i32 %6, i32 0, i32 %reduce.6.inner.indvar.reduction_dim.2
  %15 = load i32, ptr %14, align 4, !invariant.load !8
  %16 = sext i32 %15 to i64
  %constant_11_2 = load i64, ptr @7, align 8
  %17 = icmp sge i64 %16, %constant_11_2
  %18 = zext i1 %17 to i8
  %19 = getelementptr inbounds [3 x i64], ptr %arg2, i32 0, i32 %reduce.6.inner.indvar.reduction_dim.2
  %20 = load i64, ptr %19, align 8, !invariant.load !8
  %21 = icmp sle i64 %16, %20
  %22 = zext i1 %21 to i8
  %23 = and i8 %18, %22
  store i8 %13, ptr %parameter_buffer, align 1
  store i8 %23, ptr %parameter_buffer1, align 1
  call void @region_0_43_55fe6aabc4e0_d0fec12da5b9a514(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
  %24 = load i8, ptr %return_buffer, align 1
  store i8 %24, ptr %accumulator_0, align 1
...
reduce.6.inner.loop_exit.reduction_dim.2:         ; preds = %reduce.6.inner.loop_header.reduction_dim.2
  ...
  %39 = udiv i32 %37, 192
  %40 = udiv i32 %39, 4
  %41 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg0, i32 0, i32 %39, i32 %38, i32 0, i32 0
  %42 = load i32, ptr %41, align 4, !invariant.load !8
  %43 = sext i32 %42 to i64
  %44 = icmp sge i64 0, %43
  %45 = select i1 %44, i64 0, i64 %43
  %46 = icmp sle i64 3, %45
  %47 = select i1 %46, i64 3, i64 %45
  %48 = trunc i64 %47 to i32
  %49 = add i32 0, %48
  %50 = mul nuw nsw i32 %31, 1
  %51 = add nuw nsw i32 0, %50
  %52 = urem i32 %51, 192
  %53 = udiv i32 %51, 192
  %54 = udiv i32 %53, 4
  %55 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg0, i32 0, i32 %53, i32 %52, i32 0, i32 1
  %56 = load i32, ptr %55, align 4, !invariant.load !8
  %57 = sext i32 %56 to i64
  %58 = icmp sge i64 0, %57
  %59 = select i1 %58, i64 0, i64 %57
  %60 = icmp sle i64 191, %59
  %61 = select i1 %60, i64 191, i64 %59
  %62 = trunc i64 %61 to i32
  %63 = add i32 0, %62
  %64 = mul nuw nsw i32 %31, 1
  %65 = add nuw nsw i32 0, %64
  %66 = urem i32 %65, 192
  %67 = udiv i32 %65, 192
  %68 = udiv i32 %67, 4
  %69 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg0, i32 0, i32 %67, i32 %66, i32 0, i32 2
  %70 = load i32, ptr %69, align 4, !invariant.load !8
  %71 = sext i32 %70 to i64
  %72 = icmp sge i64 0, %71
  %73 = select i1 %72, i64 0, i64 %71
  %74 = icmp sle i64 1, %73
  %75 = select i1 %74, i64 1, i64 %73
  %76 = trunc i64 %75 to i32
  %77 = add i32 0, %76
  %78 = getelementptr inbounds [24 x [4 x [192 x [2 x double]]]], ptr %arg1, i32 0, i32 %34, i32 %49, i32 %63, i32 %77
  %79 = load double, ptr %78, align 8, !invariant.load !8
  %constant_4_1 = load double, ptr @5, align 8
  %80 = trunc i8 %25 to i1
  %81 = select i1 %80, double %79, double %constant_4_1
  %82 = getelementptr double, ptr %arg3, i32 %linear_index
  %83 = getelementptr inbounds double, ptr %82, i32 0
