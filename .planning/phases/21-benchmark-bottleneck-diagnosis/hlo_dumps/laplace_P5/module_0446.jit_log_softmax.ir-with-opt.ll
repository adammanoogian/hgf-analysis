...
entry:
  ...
  %thread.id.x = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !13
  %block.id.x = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !14
  ...
  %param_0.25 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr addrspace(1) %arg019, i64 0, i64 %5, i64 %6, i64 %1
  %param_0.252 = load double, ptr addrspace(1) %param_0.25, align 8, !invariant.load !15
  %7 = bitcast double %param_0.252 to <2 x i32>
...
reduction_write_output-true:                      ; preds = %entry
  %13 = fcmp uno double %param_0.252, 0.000000e+00
  %14 = insertelement <2 x i32> poison, i32 %9, i64 0
  %15 = insertelement <2 x i32> %14, i32 %11, i64 1
  %16 = bitcast <2 x i32> %15 to double
  %17 = fcmp oge double %param_0.252, %16
  %18 = or i1 %13, %17
  %maximum.1.i10 = select i1 %18, double %param_0.252, double %16
  %output_element_address = getelementptr inbounds [4 x [192 x double]], ptr addrspace(1) %arg121, i64 0, i64 %5, i64 %6
...
; Function Attrs: norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
define void @input_exponential_reduce_fusion(ptr noalias nocapture readonly align 16 dereferenceable(12288) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(6144) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(6144) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(12288) %arg3) local_unnamed_addr #0 {
entry:
  ...
  %5 = zext nneg i16 %4 to i64
  %6 = zext nneg i16 %3 to i64
  %param_0.28 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr addrspace(1) %arg029, i64 0, i64 %5, i64 %6, i64 %1
  %param_0.282 = load double, ptr addrspace(1) %param_0.28, align 8, !invariant.load !15
  %param_1.28 = getelementptr inbounds [4 x [192 x double]], ptr addrspace(1) %arg131, i64 0, i64 %5, i64 %6
  %param_1.283 = load double, ptr addrspace(1) %param_1.28, align 8, !invariant.load !15
...
__nv_exp.exit18:                                  ; preds = %__nv_exp.exit, %__internal_fast_icmp_abs_lt.exit.i15, %49
  ...
  %60 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr addrspace(1) %arg335, i64 0, i64 %5, i64 %6, i64 %1
...
reduction_write_output-true:                      ; preds = %__nv_exp.exit18
  ...
  %output_element_address = getelementptr inbounds [4 x [192 x double]], ptr addrspace(1) %arg233, i64 0, i64 %5, i64 %6
  store double %add.1.i20, ptr addrspace(1) %output_element_address, align 8
  br label %reduce-group-0-after
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_subtract_fusion_1(ptr noalias nocapture readonly align 16 dereferenceable(12288) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(6144) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(6144) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(12288) %arg3) local_unnamed_addr #3 {
entry:
  ...
  %6 = load double, ptr addrspace(1) %5, align 8, !invariant.load !15
  %7 = zext nneg i32 %3 to i64
  %8 = getelementptr inbounds double, ptr addrspace(1) %arg14, i64 %7
  %9 = load double, ptr addrspace(1) %8, align 8, !invariant.load !15
  %10 = getelementptr inbounds double, ptr addrspace(1) %arg26, i64 %7
  %11 = load double, ptr addrspace(1) %10, align 8, !invariant.load !15
...
; Function Attrs: norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
define void @input_multiply_reduce_fusion(ptr noalias nocapture readonly align 16 dereferenceable(294912) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(12288) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(147456) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(294912) %arg3) local_unnamed_addr #0 {
entry:
  %arg335 = addrspacecast ptr %arg3 to ptr addrspace(1)
  %arg233 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %arg131 = addrspacecast ptr %arg1 to ptr addrspace(1)
  ...
  %thread.id.2 = and i32 %thread.id.x, 1
  %tile_origin.1 = shl nuw nsw i32 %block.id.x, 7
  %.lhs.trunc = trunc nuw i32 %block.id.x to i8
  %1 = udiv i8 %.lhs.trunc, 6
  %2 = zext nneg i8 %1 to i64
  %3 = zext nneg i32 %thread.id.2 to i64
  %4 = or disjoint i32 %0, %tile_origin.1
  %.lhs.trunc19 = trunc nuw nsw i32 %4 to i16
  %5 = urem i16 %.lhs.trunc19, 192
  %6 = udiv i16 %.lhs.trunc19, 192
  %7 = and i16 %6, 3
  %8 = zext nneg i16 %7 to i64
  %9 = zext nneg i16 %5 to i64
  %param_0.26 = getelementptr inbounds [24 x [4 x [192 x [2 x double]]]], ptr addrspace(1) %arg029, i64 0, i64 %2, i64 %8, i64 %9, i64 %3
  %param_0.262 = load double, ptr addrspace(1) %param_0.26, align 8, !invariant.load !15
  %param_1.26 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr addrspace(1) %arg131, i64 0, i64 %8, i64 %9, i64 %3
  %param_1.263 = load double, ptr addrspace(1) %param_1.26, align 8, !invariant.load !15
  %multiply.1.1.clone.1 = fmul double %param_0.262, %param_1.263
  %add.1.i = fadd double %multiply.1.1.clone.1, 0.000000e+00
  %10 = getelementptr inbounds [24 x [4 x [192 x [2 x double]]]], ptr addrspace(1) %arg335, i64 0, i64 %2, i64 %8, i64 %9, i64 %3
...
reduction_write_output-true:                      ; preds = %entry
  ...
  %output_element_address = getelementptr inbounds [24 x [4 x [192 x double]]], ptr addrspace(1) %arg233, i64 0, i64 %2, i64 %8, i64 %9
  store double %add.1.i16, ptr addrspace(1) %output_element_address, align 8
  br label %reduce-group-0-after
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_subtract_fusion(ptr noalias nocapture readonly align 16 dereferenceable(294912) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(6144) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(147456) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(294912) %arg3) local_unnamed_addr #3 {
entry:
  ...
  %10 = urem i16 %.lhs.trunc, 768
  %11 = zext nneg i16 %10 to i64
  %12 = getelementptr inbounds double, ptr addrspace(1) %arg13, i64 %11
  %13 = load double, ptr addrspace(1) %12, align 8, !invariant.load !15
  %divide.1.3 = fdiv double %9, %13
  %subtract.5.1 = fsub double %6, %divide.1.3
  %14 = getelementptr double, ptr addrspace(1) %arg37, i64 %4
  store double %subtract.5.1, ptr addrspace(1) %14, align 8
  ret void
}
