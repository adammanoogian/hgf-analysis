...
define void @wrapped_select(ptr noalias align 16 dereferenceable(1) %arg0, ptr noalias align 16 dereferenceable(4) %arg1, ptr noalias align 16 dereferenceable(4) %arg2, ptr noalias align 128 dereferenceable(4) %arg3) {
entry:
...
wrapped_select.in_bounds-true:                    ; preds = %entry
  ...
  %5 = load i32, ptr %arg1, align 4, !invariant.load !3
  %6 = load i32, ptr %arg2, align 4, !invariant.load !3
  %7 = trunc i8 %4 to i1
  %8 = select i1 %7, i32 %5, i32 %6
  store i32 %8, ptr %arg3, align 4
