...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(32) %arg0, ptr noalias align 16 dereferenceable(32) %arg1, ptr noalias align 16 dereferenceable(1) %arg2, ptr noalias align 128 dereferenceable(32) %arg3) {
entry:
...
!1 = !{ptr @loop_select_fusion, !"reqntidx", i32 4}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 4}
!4 = !{}
