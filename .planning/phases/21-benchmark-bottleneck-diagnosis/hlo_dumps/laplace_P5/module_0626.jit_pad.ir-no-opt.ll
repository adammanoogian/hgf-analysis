...
define void @wrapped_pad(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(4608) %arg2) {
entry:
  ...
  %linear_index_in_range = icmp ult i32 %linear_index, 640
...
in_bounds-true:                                   ; preds = %wrapped_pad.in_bounds-true
  %30 = getelementptr inbounds [24 x [1 x [4 x double]]], ptr %arg0, i32 0, i32 %13, i32 0, i32 %25
