...
x_in_tile-true:                                   ; preds = %entry
  %param_02 = load double, ptr addrspace(1) %param_0, align 8, !invariant.load !6
...
; Function Attrs: norecurse nounwind memory(argmem: readwrite, inaccessiblemem: readwrite)
define void @input_reduce_fusion_1(ptr noalias nocapture readonly align 16 dereferenceable(768) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(192) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %param_0.1 = getelementptr inbounds [24 x [4 x double]], ptr addrspace(1) %arg017, i64 0, i64 %1, i64 %2
  %param_0.12 = load double, ptr addrspace(1) %param_0.1, align 8, !invariant.load !6
  %add.1.i = fadd double %param_0.12, 0.000000e+00
  %3 = bitcast double %add.1.i to <2 x i32>
  %4 = extractelement <2 x i32> %3, i64 0
  %5 = tail call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %4, i32 2, i32 31)
  %6 = insertelement <2 x i32> poison, i32 %5, i64 0
  %7 = extractelement <2 x i32> %3, i64 1
  %8 = tail call i32 @llvm.nvvm.shfl.sync.down.i32(i32 -1, i32 %7, i32 2, i32 31)
  %9 = insertelement <2 x i32> %6, i32 %8, i64 1
  %10 = bitcast <2 x i32> %9 to double
  %add.1.i13 = fadd double %add.1.i, %10
  %11 = bitcast double %add.1.i13 to <2 x i32>
  ...
  %output_element_address = getelementptr inbounds [24 x double], ptr addrspace(1) %arg119, i64 0, i64 %1
  %17 = insertelement <2 x i32> poison, i32 %13, i64 0
  %18 = insertelement <2 x i32> %17, i32 %15, i64 1
  %19 = bitcast <2 x i32> %18 to double
  %add.1.i14 = fadd double %add.1.i13, %19
...
reduction_write_output-true:                      ; preds = %entry
  store double %add.1.i14, ptr addrspace(1) %output_element_address, align 8
  br label %reduce-group-0-after
}
