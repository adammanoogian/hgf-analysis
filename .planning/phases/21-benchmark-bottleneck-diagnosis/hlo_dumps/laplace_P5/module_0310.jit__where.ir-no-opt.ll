...
define void @wrapped_select(ptr noalias align 16 dereferenceable(1) %arg0, ptr noalias align 16 dereferenceable(1) %arg1, ptr noalias align 16 dereferenceable(1) %arg2, ptr noalias align 128 dereferenceable(1) %arg3) {
entry:
...
wrapped_select.in_bounds-true:                    ; preds = %entry
  %4 = load i8, ptr %arg0, align 1, !invariant.load !3
  %5 = load i8, ptr %arg1, align 1, !invariant.load !3
  %6 = load i8, ptr %arg2, align 1, !invariant.load !3
  %7 = trunc i8 %4 to i1
  %8 = select i1 %7, i8 %5, i8 %6
  store i8 %8, ptr %arg3, align 1
