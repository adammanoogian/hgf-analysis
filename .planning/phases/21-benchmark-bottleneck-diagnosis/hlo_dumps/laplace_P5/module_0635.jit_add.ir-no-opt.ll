...
define void @wrapped_add(ptr noalias align 16 dereferenceable(192) %arg0, ptr noalias align 16 dereferenceable(192) %arg1, ptr noalias align 128 dereferenceable(192) %arg2) {
entry:
  ...
  %6 = icmp ult i32 %linear_index, 24
...
!1 = !{ptr @wrapped_add, !"reqntidx", i32 24}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 24}
!4 = !{}
