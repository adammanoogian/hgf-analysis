...
define void @loop_divide_fusion(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(768) %arg2) {
entry:
  ...
  br i1 %6, label %loop_divide_fusion.in_bounds-true, label %loop_divide_fusion.in_bounds-after
...
loop_divide_fusion.in_bounds-true:                ; preds = %entry
  ...
  %10 = load double, ptr %arg1, align 8, !invariant.load !4
  %divide.1.1 = fdiv double %9, %10
  %11 = getelementptr double, ptr %arg2, i32 %linear_index
  %12 = getelementptr inbounds double, ptr %11, i32 0
  store double %divide.1.1, ptr %12, align 8
...
!1 = !{ptr @loop_divide_fusion, !"reqntidx", i32 96}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 96}
!4 = !{}
