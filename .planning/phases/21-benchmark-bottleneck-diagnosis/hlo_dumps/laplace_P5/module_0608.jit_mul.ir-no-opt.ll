...
define void @loop_multiply_fusion(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 16 dereferenceable(32) %arg1, ptr noalias align 128 dereferenceable(768) %arg2) {
entry:
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %9 = getelementptr inbounds [1 x [1 x [4 x double]]], ptr %arg1, i32 0, i32 0, i32 0, i32 %4
