...
define void @input_slice_fusion(ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(32) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(147456) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg3, ptr noalias nocapture writeonly align 128 dereferenceable(6144) %arg4, ptr noalias nocapture writeonly align 128 dereferenceable(147456) %arg5) local_unnamed_addr #0 {
entry:
...
concatenate.pivot.0.:                             ; preds = %entry
  ...
  %9 = getelementptr inbounds [4 x double], ptr addrspace(1) %arg19, i64 0, i64 %6
...
concatenate.pivot.768.1:                          ; preds = %entry
  ...
  %19 = getelementptr inbounds [24 x [4 x double]], ptr addrspace(1) %arg313, i64 0, i64 %15, i64 %16
  br label %concatenate.merge
...
slice0-true:                                      ; preds = %concatenate.merge
  store double %add.3.2, ptr addrspace(1) %23, align 8
  br label %slice0-after

slice1-true:                                      ; preds = %slice0-after
  %sunkaddr = getelementptr inbounds i8, ptr addrspace(1) %26, i64 -6144
  store double %add.3.2, ptr addrspace(1) %sunkaddr, align 8
