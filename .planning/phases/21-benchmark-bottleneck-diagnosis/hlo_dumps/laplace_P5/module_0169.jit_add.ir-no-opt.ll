...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 16 dereferenceable(32) %arg1, ptr noalias align 128 dereferenceable(6144) %arg2) {
entry:
...
loop_add_fusion.in_bounds-true:                   ; preds = %entry
  ...
  %10 = getelementptr inbounds [4 x double], ptr %arg1, i32 0, i32 %5
