...
define void @wrapped_negate(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 128 dereferenceable(6144) %arg1) {
entry:
...
!1 = !{ptr @wrapped_negate, !"reqntidx", i32 768}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 768}
!4 = !{}
