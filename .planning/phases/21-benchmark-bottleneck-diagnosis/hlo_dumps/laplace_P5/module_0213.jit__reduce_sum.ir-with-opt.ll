...
define void @wrapped_broadcast(ptr noalias nocapture readonly align 16 dereferenceable(32) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(6144) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %5 = getelementptr inbounds [4 x double], ptr addrspace(1) %arg01, i64 0, i64 %4
