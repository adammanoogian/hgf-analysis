...
define void @loop_subtract_fusion(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(6144) %arg2) {
entry:
...
define void @wrapped_negate(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 128 dereferenceable(147456) %arg1) {
entry:
