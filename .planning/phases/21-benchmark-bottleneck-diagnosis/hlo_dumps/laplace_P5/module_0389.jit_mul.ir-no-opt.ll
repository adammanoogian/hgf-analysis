...
define void @loop_multiply_fusion(ptr noalias align 16 dereferenceable(768) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(768) %arg2) {
entry:
