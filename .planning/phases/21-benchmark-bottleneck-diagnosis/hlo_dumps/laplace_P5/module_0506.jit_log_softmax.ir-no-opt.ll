...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_8_55fe7bbcc930_79b0d34134220a8b(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_0.43 = getelementptr inbounds [1 x [4 x [192 x [2 x double]]]], ptr %arg0, i32 0, i32 0, i32 %33, i32 %32, i32 %28
  %param_0.432 = load double, ptr %param_0.43, align 8, !invariant.load !15
  store double %param_0.432, ptr %reduction_input_address, align 8
  call void @region_0_8_55fe7bbcc930_79b0d34134220a8b(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
reduction_write_output-true:                      ; preds = %thread_in_bounds-true
  ...
  %44 = udiv i32 %42, 192
  %45 = udiv i32 %44, 4
  %output_element_address = getelementptr inbounds [1 x [4 x [192 x double]]], ptr %arg1, i32 0, i32 0, i32 %44, i32 %43
...
define internal void @region_0_8_55fe7bbcc930_79b0d34134220a8b(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @loop_divide_fusion(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 128 dereferenceable(6144) %arg1, ptr noalias align 128 dereferenceable(6144) %arg2) {
entry:
...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(294912) %arg0, ptr noalias align 128 dereferenceable(6144) %arg1, ptr noalias align 16 dereferenceable(12288) %arg2, ptr noalias align 128 dereferenceable(6144) %arg3, ptr noalias align 16 dereferenceable(147456) %arg4, ptr noalias align 16 dereferenceable(6144) %arg5, ptr noalias align 128 dereferenceable(294912) %arg6) {
entry:
  ...
  %10 = urem i32 %9, 1
  %11 = udiv i32 %linear_index0, 1536
  %12 = icmp ult i32 %linear_index, 36864
  br i1 %12, label %loop_add_fusion.in_bounds-true, label %loop_add_fusion.in_bounds-after

loop_add_fusion.in_bounds-after:                  ; preds = %loop_add_fusion.in_bounds-true, %entry
  ret void

loop_add_fusion.in_bounds-true:                   ; preds = %entry
  %13 = getelementptr inbounds [24 x [4 x [192 x [1 x double]]]], ptr %arg4, i32 0, i32 %11, i32 %8, i32 %6, i32 0
  %14 = load double, ptr %13, align 8, !invariant.load !15
  %15 = fneg double %14
  %16 = getelementptr inbounds [1 x [4 x [192 x double]]], ptr %arg3, i32 0, i32 0, i32 %8, i32 %6
  %17 = load double, ptr %16, align 8, !invariant.load !15
  %multiply.12.5 = fmul double %15, %17
  %constant_0_1 = load double, ptr @1, align 8
  %18 = getelementptr inbounds [4 x [192 x [1 x double]]], ptr %arg5, i32 0, i32 %8, i32 %6, i32 0
  %19 = load double, ptr %18, align 8, !invariant.load !15
  %multiply.13.5 = fmul double %19, %19
  %divide.4.3 = fdiv double %constant_0_1, %multiply.13.5
  %multiply.14.3 = fmul double %multiply.12.5, %divide.4.3
  %20 = urem i32 %linear_index0, 1536
  %21 = getelementptr inbounds double, ptr %arg2, i32 %20
  %22 = load double, ptr %21, align 8, !invariant.load !15
  %multiply.15.3 = fmul double %multiply.14.3, %22
  %23 = udiv i32 %linear_index0, 2
  %24 = urem i32 %23, 768
  %25 = getelementptr inbounds double, ptr %arg1, i32 %24
  %26 = load double, ptr %25, align 8, !invariant.load !15
  %27 = getelementptr double, ptr %arg0, i32 %linear_index
  %28 = getelementptr inbounds double, ptr %27, i32 0
  %29 = load double, ptr %28, align 8, !invariant.load !15
  %multiply.16.1 = fmul double %26, %29
  ...
  store double %add.5.1, ptr %31, align 8
  br label %loop_add_fusion.in_bounds-after
}

define void @loop_add_fusion_1(ptr noalias align 16 dereferenceable(12288) %arg0, ptr noalias align 16 dereferenceable(12288) %arg1, ptr noalias align 128 dereferenceable(6144) %arg2, ptr noalias align 128 dereferenceable(12288) %arg3) {
entry:
  ...
  %8 = urem i32 %7, 4
  %9 = udiv i32 %linear_index0, 1536
  %10 = icmp ult i32 %linear_index, 1536
...
loop_add_fusion.1.in_bounds-true:                 ; preds = %entry
  ...
  %18 = getelementptr inbounds double, ptr %17, i32 0
  %19 = load double, ptr %18, align 8, !invariant.load !15
  %multiply.11.1 = fmul double %16, %19
  %add.4.1 = fadd double %13, %multiply.11.1
