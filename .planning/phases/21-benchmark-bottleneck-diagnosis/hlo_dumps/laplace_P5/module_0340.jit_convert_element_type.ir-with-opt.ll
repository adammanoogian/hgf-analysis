...
define void @wrapped_convert(ptr noalias nocapture readonly align 16 dereferenceable(576) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(4608) %arg1) local_unnamed_addr #0 {
entry:
...
!1 = !{ptr @wrapped_convert, !"reqntidx", i32 576}
