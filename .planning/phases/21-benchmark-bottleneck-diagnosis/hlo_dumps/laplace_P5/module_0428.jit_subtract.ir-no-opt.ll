...
define void @input_slice_fusion(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 16 dereferenceable(6144) %arg1, ptr noalias align 16 dereferenceable(147456) %arg2, ptr noalias align 16 dereferenceable(147456) %arg3, ptr noalias align 128 dereferenceable(6144) %arg4, ptr noalias align 128 dereferenceable(147456) %arg5) {
entry:
...
concat_index_from_operand_id0:                    ; preds = %concatenate.pivot.0.
  ...
  %14 = getelementptr inbounds [4 x [192 x double]], ptr %arg1, i32 0, i32 %10, i32 %9
  %15 = load double, ptr %14, align 8, !invariant.load !4
  %subtract.2.2 = fsub double %13, %15
...
concat_index_from_operand_id1:                    ; preds = %concatenate.pivot.768.1
  ...
  %27 = getelementptr inbounds [24 x [4 x [192 x double]]], ptr %arg3, i32 0, i32 %23, i32 %22, i32 %20
  %28 = load double, ptr %27, align 8, !invariant.load !4
  %subtract.3.2 = fsub double %26, %28
  br label %concatenate.merge
...
concatenate.merge:                                ; preds = %concat_index_from_operand_id1, %concat_index_from_operand_id0
  %30 = phi double [ %subtract.2.2, %concat_index_from_operand_id0 ], [ %subtract.3.2, %concat_index_from_operand_id1 ]
  %31 = icmp sge i32 %3, 0
