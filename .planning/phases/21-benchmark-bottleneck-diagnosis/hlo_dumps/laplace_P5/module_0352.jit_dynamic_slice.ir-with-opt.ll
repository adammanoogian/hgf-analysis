...
define void @wrapped_dynamic_slice(ptr noalias nocapture readonly align 16 dereferenceable(192) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(32) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %4 = tail call i32 @llvm.umin.i32(i32 %3, i32 20)
  %5 = add nuw nsw i32 %4, %0
  %6 = zext nneg i32 %5 to i64
  %7 = getelementptr inbounds [24 x double], ptr addrspace(1) %arg01, i64 0, i64 %6
