...
define void @loop_broadcast_fusion(ptr noalias align 128 dereferenceable(12288) %arg0) {
entry:
...
define void @input_scatter_fusion(ptr noalias align 128 dereferenceable(12288) %arg0, ptr noalias align 16 dereferenceable(6144) %arg1, ptr noalias align 16 dereferenceable(9216) %arg2) {
entry:
  ...
  %12 = icmp ult i32 %linear_index, 768
...
scatter.3.1.in_bounds-true:                       ; preds = %entry
  ...
  %16 = udiv i32 %14, 192
  %17 = udiv i32 %16, 4
  %param_2.2 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %16, i32 %15, i32 0, i32 0
  %param_2.21 = load i32, ptr %param_2.2, align 4, !invariant.load !8
  %18 = add i32 %10, %param_2.21
  %19 = icmp ult i32 %param_2.21, 4
  %20 = and i1 true, %19
  ...
  %24 = udiv i32 %22, 192
  %25 = udiv i32 %24, 4
  %param_2.22 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %24, i32 %23, i32 0, i32 1
  ...
  %32 = udiv i32 %30, 192
  %33 = udiv i32 %32, 4
  %param_2.24 = getelementptr inbounds [4 x [192 x [1 x [3 x i32]]]], ptr %arg2, i32 0, i32 %32, i32 %31, i32 0, i32 2
...
scatter.in_bounds-true:                           ; preds = %scatter.3.1.in_bounds-true
  %37 = getelementptr inbounds [4 x [192 x [2 x [1 x double]]]], ptr %arg0, i32 0, i32 %18, i32 %26, i32 %34, i32 0
