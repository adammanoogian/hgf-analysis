...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 128 dereferenceable(6144) %arg1) {
entry:
...
wrapped_transpose.in_bounds-true:                 ; preds = %entry
  %9 = getelementptr inbounds [4 x [192 x [1 x double]]], ptr %arg0, i32 0, i32 %6, i32 %7, i32 0
