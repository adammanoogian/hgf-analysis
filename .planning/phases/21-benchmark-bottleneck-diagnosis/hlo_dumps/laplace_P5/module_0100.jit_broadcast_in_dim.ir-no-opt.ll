...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(4) %arg0, ptr noalias align 128 dereferenceable(768) %arg1) {
entry:
...
wrapped_broadcast.in_bounds-true:                 ; preds = %entry
  %5 = load i32, ptr %arg0, align 4, !invariant.load !4
  %6 = getelementptr i32, ptr %arg1, i32 %linear_index
