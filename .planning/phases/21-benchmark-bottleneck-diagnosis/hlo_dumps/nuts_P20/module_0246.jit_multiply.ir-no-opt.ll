...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  %param_0.1 = getelementptr inbounds [20 x [192 x double]], ptr %arg0, i32 0, i32 %10, i32 %11
  %param_0.12 = load double, ptr %param_0.1, align 8, !invariant.load !4
  %param_1 = getelementptr inbounds [20 x [192 x double]], ptr %arg1, i32 0, i32 %10, i32 %11
...
loop2.loop_body12:                                ; preds = %loop2.loop_header11
  ...
  %22 = getelementptr inbounds [192 x [20 x double]], ptr %arg2, i32 0, i32 %17, i32 %18
