...
define void @input_transpose_fusion(ptr noalias align 16 dereferenceable(30720) %arg0, ptr noalias align 16 dereferenceable(30720) %arg1, ptr noalias align 128 dereferenceable(30720) %arg2) {
entry:
...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  %param_1.1 = getelementptr inbounds [192 x [20 x double]], ptr %arg1, i32 0, i32 %10, i32 %11
