...
reduce.7.1.inner.loop_body.reduction_dim.0:       ; preds = %reduce.7.1.inner.loop_header.reduction_dim.0
  ...
  call void @region_0_3_557ce3b815b0_39628a19d3ab0b42(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
...
define internal void @region_0_3_557ce3b815b0_39628a19d3ab0b42(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
