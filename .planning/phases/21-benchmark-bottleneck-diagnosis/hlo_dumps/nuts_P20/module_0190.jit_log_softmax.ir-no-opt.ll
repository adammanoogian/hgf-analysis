...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_557ce73d8960_2dd93d124632ffa4(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  call void @region_0_6_557ce73d8960_2dd93d124632ffa4(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_6_557ce73d8960_2dd93d124632ffa4(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  %20 = bitcast i64 %19 to double
  store double %20, ptr %result_from_other_lane, align 8
  call void @region_1_18_557ce73d8ef0_39628a19d3ab0b42(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer10)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  call void @region_1_18_557ce73d8ef0_39628a19d3ab0b42(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_1_18_557ce73d8ef0_39628a19d3ab0b42(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
  %2 = alloca double, align 8
