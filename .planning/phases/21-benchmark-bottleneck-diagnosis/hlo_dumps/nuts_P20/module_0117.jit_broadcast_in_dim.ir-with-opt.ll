...
define void @wrapped_broadcast(ptr noalias nocapture readonly align 16 dereferenceable(4) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(80) %arg1) local_unnamed_addr #0 {
entry:
