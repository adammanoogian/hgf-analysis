...
define void @wrapped_multiply(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(8) %arg2) {
entry:
...
wrapped_multiply.in_bounds-true:                  ; preds = %entry
  ...
  store double %multiply.1.1, ptr %arg2, align 8
