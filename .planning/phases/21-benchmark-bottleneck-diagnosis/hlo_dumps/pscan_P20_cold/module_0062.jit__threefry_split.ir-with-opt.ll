...
define void @input_concatenate_fusion(ptr noalias nocapture readonly align 16 dereferenceable(8) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(24) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %81 = getelementptr inbounds [6 x i32], ptr addrspace(1) %arg1100, i64 0, i64 %80
  store i32 %79, ptr addrspace(1) %81, align 4
  %82 = tail call i32 @llvm.fshl.i32(i32 %77, i32 %77, i32 6)
  %83 = xor i32 %78, %82
  %84 = add i32 %2, 5
  %85 = add i32 %84, %83
  %86 = getelementptr inbounds i8, ptr addrspace(1) %81, i64 12
