; ModuleID = 'jit_sub'
source_filename = "jit_sub"
target datalayout = "e-i64:64-i128:128-v16:16-v32:32-n16:32:64"
target triple = "nvptx64-nvidia-cuda"

define void @loop_subtract_fusion(ptr noalias align 16 dereferenceable(160) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(160) %arg2) {
entry:
  ...
  br i1 %4, label %loop_subtract_fusion.in_bounds-true, label %loop_subtract_fusion.in_bounds-after
...
loop_subtract_fusion.in_bounds-true:              ; preds = %entry
  ...
  store double %subtract.1.1, ptr %10, align 8
...
!1 = !{ptr @loop_subtract_fusion, !"reqntidx", i32 20}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 20}
!4 = !{}
