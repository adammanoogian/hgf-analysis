...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(30720) %arg0, ptr noalias align 128 dereferenceable(30720) %arg1) {
entry:
...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  %param_0 = getelementptr inbounds [20 x [192 x [1 x double]]], ptr %arg0, i32 0, i32 %10, i32 %11, i32 0
...
loop2.loop_body11:                                ; preds = %loop2.loop_header10
  ...
  %22 = getelementptr inbounds [192 x [20 x [1 x double]]], ptr %arg1, i32 0, i32 %17, i32 %18, i32 0
