...
define void @wrapped_multiply(ptr noalias nocapture readonly align 16 dereferenceable(160) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(160) %arg1) local_unnamed_addr #0 {
entry:
  ...
  %multiply.1.1 = fmul double %3, %3
  %4 = getelementptr double, ptr addrspace(1) %arg13, i64 %1
  store double %multiply.1.1, ptr addrspace(1) %4, align 8
  ret void
}
...
!1 = !{ptr @wrapped_multiply, !"reqntidx", i32 20}
