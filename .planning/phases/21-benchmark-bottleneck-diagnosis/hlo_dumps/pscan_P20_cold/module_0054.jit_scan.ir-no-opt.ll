...
loop_divide_fusion.2.in_bounds-true:              ; preds = %entry
  ...
  %multiply.192.9 = fmul double %11, %12
  %add.79.7 = fadd double %8, %multiply.192.9
  %13 = call double @__nv_exp(double %add.79.7)
  %multiply.193.3 = fmul double %7, %13
  %constant_79_4 = load double, ptr @4, align 8
  %compare.31.6 = fcmp ogt double %multiply.193.3, %constant_79_4
  %14 = zext i1 %compare.31.6 to i8
  %constant_81_2 = load double, ptr @3, align 8
  %15 = trunc i8 %14 to i1
  %16 = select i1 %15, double %multiply.193.3, double %constant_81_2
  %add.80.5 = fadd double %divide.82.1.clone.1, %16
  %divide.83.1 = fdiv double %constant_77_4, %add.80.5
...
define void @loop_select_fusion(ptr noalias align 128 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(8) %arg2, ptr noalias align 16 dereferenceable(8) %arg3, ptr noalias align 128 dereferenceable(8) %arg4) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !22
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !22
  %2 = mul nuw nsw i32 %0, 1
...
loop_select_fusion.in_bounds-true:                ; preds = %entry
  ...
  %multiply.175.3 = fmul double %7, %10
  %11 = load double, ptr %arg2, align 8, !invariant.load !23
  %multiply.176.7 = fmul double %multiply.175.3, %11
  %12 = load i64, ptr %arg1, align 8, !invariant.load !23
...
loop_add_divide_multiply_subtract_fusion.in_bounds-true: ; preds = %entry
  ...
  %constant_79_3_clone_1 = load double, ptr @10, align 8
  %compare.31.2.clone.1 = fcmp ogt double %multiply.193.5.clone.1, %constant_79_3_clone_1
  %19 = zext i1 %compare.31.2.clone.1 to i8
  ...
  %add.80.3.clone.1 = fadd double %23, %21
  %24 = load double, ptr %arg9, align 8, !invariant.load !23
  %multiply.200.1.clone.1 = fmul double %add.80.3.clone.1, %24
  ...
  %multiply.206.3.clone.1 = fmul double %8, %44
  %constant_79_3_clone_14 = load double, ptr @10, align 8
  %compare.33.1.clone.1 = fcmp ogt double %multiply.206.3.clone.1, %constant_79_3_clone_14
  %45 = zext i1 %compare.33.1.clone.1 to i8
  %constant_81_1_clone_15 = load double, ptr @9, align 8
  %46 = trunc i8 %45 to i1
  %47 = select i1 %46, double %multiply.206.3.clone.1, double %constant_81_1_clone_15
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  ...
  %constant_79_1 = load double, ptr @15, align 8
  %compare.33.2 = fcmp ogt double %multiply.206.5, %constant_79_1
  %9 = zext i1 %compare.33.2 to i8
...
define void @loop_select_fusion_1(ptr noalias align 128 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(8) %arg3, ptr noalias align 16 dereferenceable(8) %arg4, ptr noalias align 128 dereferenceable(8) %arg5) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !22
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !22
  %2 = mul nuw nsw i32 %0, 1
...
loop_select_fusion.1.in_bounds-true:              ; preds = %entry
  %4 = load double, ptr %arg0, align 8, !invariant.load !23
  %5 = getelementptr double, ptr %arg4, i32 %linear_index
  %6 = getelementptr inbounds double, ptr %5, i32 0
  %7 = load double, ptr %6, align 8, !invariant.load !23
  %8 = load double, ptr %arg3, align 8, !invariant.load !23
  %multiply.179.5 = fmul double %7, %8
  %multiply.180.3 = fmul double %multiply.179.5, %multiply.179.5
  %constant_14_1 = load double, ptr @18, align 8
  %multiply.181.3 = fmul double %multiply.180.3, %constant_14_1
  %9 = load double, ptr %arg2, align 8, !invariant.load !23
  %multiply.182.3 = fmul double %multiply.180.3, %9
  ...
  %10 = load double, ptr %arg3, align 8, !invariant.load !23
