...
entry:
  ...
  %param_0.15 = getelementptr inbounds [20 x [192 x [2 x double]]], ptr addrspace(1) %arg019, i64 0, i64 %5, i64 %6, i64 %1
...
entry:
  ...
  %5 = zext nneg i16 %4 to i64
  %6 = zext nneg i16 %3 to i64
  %param_0.17 = getelementptr inbounds [20 x [192 x [2 x double]]], ptr addrspace(1) %arg029, i64 0, i64 %5, i64 %6, i64 %1
  %param_0.172 = load double, ptr addrspace(1) %param_0.17, align 8, !invariant.load !11
  %param_1.14 = getelementptr inbounds [20 x [192 x double]], ptr addrspace(1) %arg131, i64 0, i64 %5, i64 %6
...
define void @loop_subtract_fusion(ptr noalias nocapture readonly align 16 dereferenceable(61440) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(30720) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(30720) %arg2, ptr noalias nocapture writeonly align 128 dereferenceable(61440) %arg3) local_unnamed_addr #3 {
entry:
