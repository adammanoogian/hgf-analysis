...
define void @wrapped_concatenate(ptr noalias nocapture readonly align 16 dereferenceable(30720) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(30720) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(61440) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %10 = getelementptr inbounds [20 x [192 x [2 x double]]], ptr addrspace(1) %arg212, i64 0, i64 %8, i64 %9, i64 0
