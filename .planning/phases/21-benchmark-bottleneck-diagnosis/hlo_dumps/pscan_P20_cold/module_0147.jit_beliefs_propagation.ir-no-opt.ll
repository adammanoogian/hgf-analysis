...
define void @input_slice_fusion(ptr noalias align 128 dereferenceable(160) %arg0, ptr noalias align 128 dereferenceable(160) %arg1, ptr noalias align 128 dereferenceable(160) %arg2) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !2
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !3
  %2 = mul nuw nsw i32 %0, 60
  %linear_index = add nuw nsw i32 %2, %1
  %linear_index_in_range = icmp ult i32 %linear_index, 60
  call void @llvm.assume(i1 %linear_index_in_range)
  %linear_index0 = add nuw nsw i32 %linear_index, 0
  %3 = udiv i32 %linear_index0, 1
  %4 = icmp ult i32 %linear_index, 60
...
concat_index_from_operand_id1:                    ; preds = %concatenate.pivot.20.2
  %7 = phi i32 [ 20, %concatenate.pivot.20.2 ]
  %8 = sub nsw i32 %3, %7
  %constant_15_31 = load double, ptr @1, align 8
  br label %concatenate.merge

concat_index_from_operand_id2:                    ; preds = %concatenate.pivot.40.3
  %9 = phi i32 [ 40, %concatenate.pivot.40.3 ]
  %10 = sub nsw i32 %3, %9
  %constant_16_2 = load double, ptr @0, align 8
  br label %concatenate.merge

concatenate.pivot.20.:                            ; preds = %input_slice_fusion.in_bounds-true
  %11 = icmp ult i32 %3, 20
  br i1 %11, label %concatenate.pivot.0., label %concatenate.pivot.40.
...
concatenate.pivot.40.:                            ; preds = %concatenate.pivot.20.
  %12 = icmp ult i32 %3, 40
  br i1 %12, label %concatenate.pivot.20.2, label %concatenate.pivot.40.3

concatenate.pivot.20.2:                           ; preds = %concatenate.pivot.40.
  br label %concat_index_from_operand_id1

concatenate.pivot.40.3:                           ; preds = %concatenate.pivot.40.
...
slice0-true:                                      ; preds = %concatenate.merge
  %23 = sub i32 %3, 0
  %24 = getelementptr inbounds [20 x double], ptr %arg0, i32 0, i32 %23
  store double %13, ptr %24, align 8
  br label %slice0-after

slice1-true:                                      ; preds = %slice0-after
  %25 = sub i32 %3, 20
  %26 = getelementptr inbounds [20 x double], ptr %arg1, i32 0, i32 %25
  store double %13, ptr %26, align 8
  br label %slice1-after

slice2-true:                                      ; preds = %slice1-after
  %27 = sub i32 %3, 40
  %28 = getelementptr inbounds [20 x double], ptr %arg2, i32 0, i32 %27
