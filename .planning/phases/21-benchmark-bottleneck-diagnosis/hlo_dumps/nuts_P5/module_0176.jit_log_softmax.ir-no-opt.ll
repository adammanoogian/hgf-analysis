...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_557ff6d099d0_e410f936d6284c04(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_0.15 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  ...
  call void @region_0_6_557ff6d099d0_e410f936d6284c04(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_6_557ff6d099d0_e410f936d6284c04(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  %20 = bitcast i64 %19 to double
  store double %20, ptr %result_from_other_lane, align 8
  call void @region_1_18_557ff6b84e90_c5d0f531a335066f(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer10)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %35 = mul nuw nsw i32 %24, 1
  %36 = add nuw nsw i32 0, %35
  %param_0.17 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  %param_0.172 = load double, ptr %param_0.17, align 8, !invariant.load !13
  %param_1.14 = getelementptr inbounds [4 x [192 x double]], ptr %arg1, i32 0, i32 %33, i32 %32
  ...
  call void @region_1_18_557ff6b84e90_c5d0f531a335066f(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
  ...
  %param_0.174 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %45, i32 %44, i32 %40
  %param_0.175 = load double, ptr %param_0.174, align 8, !invariant.load !13
  %param_1.146 = getelementptr inbounds [4 x [192 x double]], ptr %arg1, i32 0, i32 %45, i32 %44
...
define internal void @region_1_18_557ff6b84e90_c5d0f531a335066f(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
  %2 = alloca double, align 8
...
define void @loop_subtract_fusion(ptr noalias align 16 dereferenceable(12288) %arg0, ptr noalias align 128 dereferenceable(6144) %arg1, ptr noalias align 128 dereferenceable(6144) %arg2, ptr noalias align 128 dereferenceable(12288) %arg3) {
entry:
