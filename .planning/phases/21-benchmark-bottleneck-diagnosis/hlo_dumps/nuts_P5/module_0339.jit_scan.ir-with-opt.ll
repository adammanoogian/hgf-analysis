...
concatenate.37.1.merge:                           ; preds = %concatenate.pivot.20.15, %concatenate.pivot.16.14, %concatenate.pivot.12.13, %concatenate.pivot.8.12, %concatenate.pivot.4.11, %concatenate.pivot.0.
  ...
  %multiply.3002.78.sink = fmul double %multiply.3002.78.sink.in, 0x3FACE38005B2A090
...
loop1.loop_body.lr.ph:                            ; preds = %entry
  ...
  %multiply.3000.3.clone.1 = fmul double %10, 0x3FBCE38005B2A090
...
concatenate.pivot.0.:                             ; preds = %concatenate.pivot.4.
  ...
  %multiply.3002.11 = fmul double %19, 0x3FACE38005B2A090
...
concatenate.pivot.8.:                             ; preds = %concatenate.pivot.4.
  ...
  %multiply.3002.114 = fmul double %38, 0x3FACE38005B2A090
...
concatenate.pivot.4.27:                           ; preds = %concatenate.pivot.8.
  ...
  %56 = load double, ptr addrspace(1) %55, align 8, !invariant.load !263
  %multiply.3000.39 = fmul double %38, 0x3FBCE38005B2A090
...
concatenate.pivot.8.28:                           ; preds = %concatenate.pivot.8.
  ...
  %82 = load double, ptr addrspace(1) %81, align 8, !invariant.load !263
  %multiply.3000.3911 = fmul double %38, 0x3FBCE38005B2A090
  %83 = zext nneg i32 %1 to i64
...
concatenate.pivot.12.29:                          ; preds = %concatenate.pivot.16.
  ...
  %multiply.3002.1116 = fmul double %105, 0x3FACE38005B2A090
...
concatenate.pivot.20.:                            ; preds = %concatenate.pivot.16.
  ...
  %multiply.3002.1121 = fmul double %119, 0x3FACE38005B2A090
...
concatenate.pivot.0.114:                          ; preds = %concatenate.pivot.4.113
  ...
  %multiply.3002.1134 = fmul double %170, 0x3FACE38005B2A090
...
concatenate.pivot.8.115:                          ; preds = %concatenate.pivot.4.113
  ...
  %multiply.3002.1144 = fmul double %184, 0x3FACE38005B2A090
...
concatenate.pivot.4.116:                          ; preds = %concatenate.pivot.8.115
  ...
  %multiply.3000.3948 = fmul double %184, 0x3FBCE38005B2A090
...
concatenate.pivot.8.117:                          ; preds = %concatenate.pivot.8.115
  ...
  %multiply.3000.3966 = fmul double %184, 0x3FBCE38005B2A090
...
concatenate.pivot.12.119:                         ; preds = %concatenate.pivot.16.118
  ...
  %multiply.3002.1179 = fmul double %232, 0x3FACE38005B2A090
...
concatenate.pivot.20.120:                         ; preds = %concatenate.pivot.16.118
  ...
  %multiply.3002.1190 = fmul double %243, 0x3FACE38005B2A090
...
loop1.loop_body.lr.ph:                            ; preds = %entry
  ...
  %multiply.3002.25.clone.1 = fmul double %12, 0x3FACE38005B2A090
...
entry:
  ...
  %multiply.3000.27.clone.1 = fmul double %36, 0x3FBCE38005B2A090
  %37 = or i32 %0, 4
  ...
  %multiply.3002.23.clone.1 = fmul double %36, 0x3FACE38005B2A090
