...
reduce.4.inner.loop_body.reduction_dim.2:         ; preds = %reduce.4.inner.loop_header.reduction_dim.2
  ...
  call void @region_0_37_557ff704a6d0_aea6391cb20f9f3e(ptr %parameter_buffer, ptr %parameter_buffer1, ptr %return_buffer)
...
define internal void @region_0_37_557ff704a6d0_aea6391cb20f9f3e(ptr dereferenceable(1) %0, ptr dereferenceable(1) %1, ptr dereferenceable(1) %output_arg) {
entry:
  %2 = alloca i8, align 1
