...
define void @wrapped_subtract(ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(6144) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %subtract.1.1 = fsub double %3, %5
  %6 = getelementptr double, ptr addrspace(1) %arg25, i64 %1
  store double %subtract.1.1, ptr addrspace(1) %6, align 8
  ret void
}
...
!1 = !{ptr @wrapped_subtract, !"reqntidx", i32 768}
