...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(20) %arg0, ptr noalias align 128 dereferenceable(20) %arg1) {
entry:
...
wrapped_transpose.in_bounds-true:                 ; preds = %entry
  %7 = getelementptr inbounds [10 x [2 x i8]], ptr %arg0, i32 0, i32 %4, i32 %5
  %8 = load i8, ptr %7, align 1, !invariant.load !4
