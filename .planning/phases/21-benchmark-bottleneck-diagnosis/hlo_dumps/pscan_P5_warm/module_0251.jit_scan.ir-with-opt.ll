...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_add_fusion(ptr noalias nocapture readonly align 128 dereferenceable(32) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg4, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg5, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg6, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg7, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg8, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg9, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg10, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg11, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg12, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg13, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg14, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg15, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg16, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg17, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg18, ptr noalias nocapture readonly align 16 dereferenceable(3072) %arg19, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg20, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg21, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg22, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg23, ptr noalias nocapture writeonly align 128 dereferenceable(32) %arg24) local_unnamed_addr #0 {
entry:
  ...
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !28
  %1 = load i64, ptr addrspace(1) %arg1140, align 128, !invariant.load !27
  %2 = sub i64 191, %1
  %3 = icmp slt i64 %2, 0
  %4 = sub i64 383, %1
  %5 = select i1 %3, i64 %4, i64 %2
  ...
  %9 = zext nneg i32 %8 to i64
  %10 = zext nneg i32 %0 to i64
  %11 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg528, i64 0, i64 %9, i64 %10
  %12 = load i8, ptr addrspace(1) %11, align 1, !invariant.load !27
  ...
  %20 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg2262, i64 0, i64 %9, i64 %10
  %21 = load i8, ptr addrspace(1) %20, align 1, !invariant.load !27
  %22 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg2160, i64 0, i64 %9, i64 %10
  %23 = load double, ptr addrspace(1) %22, align 8, !invariant.load !27
  %24 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg2058, i64 0, i64 %9, i64 %10
  %25 = load i8, ptr addrspace(1) %24, align 1, !invariant.load !27
  %26 = getelementptr inbounds [192 x [4 x i32]], ptr addrspace(1) %arg1956, i64 0, i64 %9, i64 %10
  ...
  %35 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1752, i64 0, i64 %9, i64 %10
  %36 = load double, ptr addrspace(1) %35, align 8, !invariant.load !27
  %multiply.375.11 = fmul double %36, %34
  %37 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1650, i64 0, i64 %9, i64 %10
  %38 = load double, ptr addrspace(1) %37, align 8, !invariant.load !27
  %multiply.377.9 = fmul double %38, %multiply.375.11
  %39 = fmul double %23, %multiply.375.11
  %add.241.7 = fsub double %multiply.377.9, %39
  %40 = trunc i8 %21 to i1
  %41 = select i1 %40, double %add.241.7, double 0.000000e+00
  %42 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1548, i64 0, i64 %9, i64 %10
  ...
  %47 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1344, i64 0, i64 %9, i64 %10
  %48 = load double, ptr addrspace(1) %47, align 8, !invariant.load !27
  %multiply.378.17 = fmul double %46, %48
  %49 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1242, i64 0, i64 %9, i64 %10
  ...
  %51 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg222, i64 0, i64 %9, i64 %10
  %52 = load double, ptr addrspace(1) %51, align 8, !invariant.load !27
  %53 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg120, i64 0, i64 %9, i64 %10
  ...
  %60 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg834, i64 0, i64 %9, i64 %10
  ...
  %63 = getelementptr double, ptr addrspace(1) %arg1038, i64 %10
  ...
  %66 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg936, i64 0, i64 %9, i64 %10
  ...
  %68 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg630, i64 0, i64 %9, i64 %10
...
entry:
  ...
  %multiply.377.7.clone.1 = fmul double %53, %multiply.375.9.clone.1
  %54 = fmul double %38, %multiply.375.9.clone.1
  %add.241.5.clone.1 = fsub double %multiply.377.7.clone.1, %54
  ...
  %add.248.7.clone.1 = fsub double %26, %add.245.3.clone.1
  %68 = select i1 %15, double %add.240.5.clone.1, double 0.000000e+00
  %add.246.3.clone.1 = fadd double %68, %add.245.3.clone.1
  %add.249.3.clone.1 = fadd double %23, %add.246.3.clone.1
  %add.250.5.clone.1 = fadd double %add.248.7.clone.1, %add.249.3.clone.1
  ...
  %add.251.11.clone.1 = fadd double %23, %71
  ...
  %add.254.9.clone.1 = fadd double %add.251.11.clone.1, %85
  ...
  %add.255.13.clone.1 = select i1 %15, double %92, double 0.000000e+00
  ...
  %multiply.400.13.clone.1 = fmul double %94, %divide.19.13.clone.1
  %99 = getelementptr double, ptr addrspace(1) %arg841, i64 %10
  %100 = load double, ptr addrspace(1) %99, align 8, !invariant.load !27
  %add.256.11.clone.1 = fadd double %100, %multiply.400.13.clone.1
  %add.257.11.clone.1 = fadd double %add.255.13.clone.1, %add.256.11.clone.1
  %add.258.9.clone.1 = fadd double %23, %add.257.11.clone.1
  ...
  %add.259.7.clone.1 = fadd double %106, %add.258.9.clone.1
  %107 = fmul double %87, %add.259.7.clone.1
  %add.260.7.clone.1 = fsub double %add.254.9.clone.1, %107
  ...
  %multiply.404.9.clone.1 = fmul double %109, %add.259.7.clone.1
  %add.261.7.clone.1 = fadd double %multiply.404.9.clone.1, %add.260.7.clone.1
  ...
  %add.262.3.clone.1 = fadd double %add.250.5.clone.1, %multiply.405.5.clone.1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_add_select_fusion_1(ptr noalias nocapture align 128 dereferenceable(32) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg1, ptr noalias nocapture align 128 dereferenceable(32) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg4, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg5, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg6, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg7, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg8, ptr noalias nocapture readonly align 16 dereferenceable(3072) %arg9, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg10, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg11, ptr noalias nocapture align 128 dereferenceable(32) %arg12, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg13, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg14, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg15, ptr noalias nocapture align 128 dereferenceable(32) %arg16, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg17, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg18, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg19, ptr noalias nocapture align 128 dereferenceable(32) %arg20, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg21, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg22, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg23, ptr noalias nocapture readonly align 16 dereferenceable(1536) %arg24, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg25, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg26, ptr noalias nocapture align 128 dereferenceable(32) %arg27, ptr noalias nocapture align 128 dereferenceable(32) %arg28, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg29, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg30, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg31, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg32, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg33, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg34, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg35, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg36, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg37, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg38, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg39, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg40, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg41, ptr noalias nocapture align 128 dereferenceable(32) %arg42, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg43, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg44, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg45, ptr noalias nocapture align 128 dereferenceable(32) %arg46, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg47, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg48, ptr noalias nocapture align 128 dereferenceable(32) %arg49, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg50, ptr noalias nocapture align 128 dereferenceable(32) %arg51, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg52, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg53, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg54, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg55, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg56, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg57, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg58, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg59, ptr noalias nocapture align 128 dereferenceable(32) %arg60, ptr noalias nocapture align 128 dereferenceable(32) %arg61, ptr noalias nocapture readonly align 128 dereferenceable(32) %arg62, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg63, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg64, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg65, ptr noalias nocapture readonly align 16 dereferenceable(768) %arg66, ptr noalias nocapture align 128 dereferenceable(32) %arg67, ptr noalias nocapture readnone align 16 dereferenceable(768) %arg68, ptr noalias nocapture align 128 dereferenceable(32) %arg69, ptr noalias nocapture align 128 dereferenceable(32) %arg70) local_unnamed_addr #0 {
entry:
  ...
  %15 = trunc i8 %12 to i1
  %16 = select i1 %15, double 0.000000e+00, double %14
  %17 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg663, i64 0, i64 %9, i64 %10
  ...
  %27 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg561, i64 0, i64 %9, i64 %10
  %28 = load double, ptr addrspace(1) %27, align 8, !invariant.load !27
  %29 = fneg double %26
  ...
  %38 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg1989, i64 0, i64 %9, i64 %10
  %39 = load i8, ptr addrspace(1) %38, align 1, !invariant.load !27
  %40 = getelementptr inbounds [192 x [4 x i8]], ptr addrspace(1) %arg1887, i64 0, i64 %9, i64 %10
  ...
  %48 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1785, i64 0, i64 %9, i64 %10
  ...
  %53 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1581, i64 0, i64 %9, i64 %10
  %54 = load double, ptr addrspace(1) %53, align 8, !invariant.load !27
  %multiply.378.13 = fmul double %52, %54
  %55 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1479, i64 0, i64 %9, i64 %10
  ...
  %add.291.11 = fadd double %37, %add.290.9
  %add.292.9 = fadd double %34, %add.291.11
  %60 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1377, i64 0, i64 %9, i64 %10
  %61 = load double, ptr addrspace(1) %60, align 8, !invariant.load !27
  ...
  %65 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg1173, i64 0, i64 %9, i64 %10
  %66 = load double, ptr addrspace(1) %65, align 8, !invariant.load !27
  %67 = fneg double %add.294.7
  %68 = fmul double %66, %67
  %69 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg459, i64 0, i64 %9, i64 %10
  %70 = load double, ptr addrspace(1) %69, align 8, !invariant.load !27
  ...
  %74 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg357, i64 0, i64 %9, i64 %10
  ...
  %add.298.3 = fadd double %add.289.5, %add.297.5
  ...
  %multiply.438.9.clone.1 = fmul double %add.293.9, %91
  %add.304.7.clone.1 = fadd double %68, %multiply.438.9.clone.1
  %92 = trunc i8 %89 to i1
  %93 = select i1 %92, double %add.304.7.clone.1, double 0.000000e+00
  %multiply.439.7.clone.1 = fmul double %87, %93
  ...
  %multiply.440.5.clone.1 = fmul double %95, %multiply.439.7.clone.1
  %add.306.3.clone.1 = fadd double %add.303.5.clone.1, %multiply.440.5.clone.1
  ...
  %multiply.377.11.clone.1 = fmul double %118, %multiply.375.13.clone.1
  %119 = fmul double %113, %multiply.375.13.clone.1
  %add.241.9.clone.1 = fsub double %multiply.377.11.clone.1, %119
  ...
  %multiply.407.7.clone.1 = fmul double %126, %add.243.7.clone.1
  ...
  %divide.20.7.clone.1 = fdiv double %add.243.7.clone.1, %128
  %add.265.5.clone.1 = fadd double %multiply.407.7.clone.1, %divide.20.7.clone.1
  %add.266.7.clone.1 = fadd double %108, %add.265.5.clone.1
  ...
  %multiply.415.9.clone.1 = fmul double %141, %multiply.414.9.clone.1
  %add.269.7.clone.1 = fadd double %add.268.9.clone.1, %multiply.415.9.clone.1
  ...
  %multiply.417.9.clone.1 = fmul double %148, %multiply.416.9.clone.1
  %add.270.7.clone.1 = fadd double %146, %multiply.417.9.clone.1
  %add.271.7.clone.1 = fadd double %135, %add.270.7.clone.1
  ...
  %171 = getelementptr double, ptr addrspace(1) %arg51153, i64 %10
  %172 = load double, ptr addrspace(1) %171, align 8
  %173 = select i1 %15, double 0.000000e+00, double %172
  %174 = getelementptr double, ptr addrspace(1) %arg47145, i64 %10
  %175 = load double, ptr addrspace(1) %174, align 8, !invariant.load !27
  %176 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg50151, i64 0, i64 %9, i64 %10
  %177 = load double, ptr addrspace(1) %176, align 8, !invariant.load !27
  %178 = getelementptr double, ptr addrspace(1) %arg49149, i64 %10
  %179 = load double, ptr addrspace(1) %178, align 8
  %180 = select i1 %15, double %179, double 0.000000e+00
  %add.274.9.clone.1 = fadd double %34, %180
  %181 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg48147, i64 0, i64 %9, i64 %10
  %182 = load double, ptr addrspace(1) %181, align 8, !invariant.load !27
  %183 = fneg double %add.274.9.clone.1
  ...
  %189 = getelementptr inbounds [192 x [4 x [1 x i8]]], ptr addrspace(1) %arg66183, i64 0, i64 %9, i64 %10, i64 0
  %190 = load i8, ptr addrspace(1) %189, align 1, !invariant.load !27
  %191 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg65181, i64 0, i64 %9, i64 %10
  %192 = load double, ptr addrspace(1) %191, align 8, !invariant.load !27
  %multiply.441.9.clone.1 = fmul double %multiply.408.9.clone.1, %192
  %multiply.442.7.clone.1 = fmul double %multiply.441.9.clone.1, 5.000000e-01
  %193 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg64179, i64 0, i64 %9, i64 %10
  %194 = load double, ptr addrspace(1) %193, align 8, !invariant.load !27
  %multiply.443.5.clone.1 = fmul double %194, %multiply.442.7.clone.1
  %multiply.444.7.clone.1 = fmul double %multiply.411.9.clone.1, %192
  %add.310.5.clone.1 = fadd double %multiply.444.7.clone.1, %multiply.443.5.clone.1
  %multiply.445.9.clone.1 = fmul double %multiply.414.9.clone.1, %192
  %add.311.7.clone.1 = fadd double %multiply.445.9.clone.1, %add.310.5.clone.1
  %195 = trunc i8 %190 to i1
  %196 = select i1 %195, double %add.311.7.clone.1, double 0.000000e+00
  %197 = getelementptr inbounds [192 x [4 x double]], ptr addrspace(1) %arg63177, i64 0, i64 %9, i64 %10
  %198 = load double, ptr addrspace(1) %197, align 8, !invariant.load !27
  %multiply.446.5.clone.1 = fmul double %multiply.416.9.clone.1, %198
  %add.312.3.clone.1 = fadd double %multiply.446.5.clone.1, %196
  %199 = getelementptr double, ptr addrspace(1) %arg62175, i64 %10
  %200 = load double, ptr addrspace(1) %199, align 8, !invariant.load !27
  %add.313.1.clone.1 = fadd double %200, %add.312.3.clone.1
  %add.314.1.clone.1 = fadd double %add.309.3.clone.1, %add.313.1.clone.1
