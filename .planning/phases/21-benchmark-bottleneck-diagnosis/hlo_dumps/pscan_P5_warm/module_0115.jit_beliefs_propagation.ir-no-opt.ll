...
define void @input_slice_fusion(ptr noalias align 128 dereferenceable(32) %arg0, ptr noalias align 128 dereferenceable(32) %arg1, ptr noalias align 128 dereferenceable(32) %arg2) {
entry:
...
concat_index_from_operand_id1:                    ; preds = %concatenate.pivot.4.2
  %7 = phi i32 [ 4, %concatenate.pivot.4.2 ]
  %8 = sub nsw i32 %3, %7
  %constant_15_31 = load double, ptr @1, align 8
  br label %concatenate.merge

concat_index_from_operand_id2:                    ; preds = %concatenate.pivot.8.3
  %9 = phi i32 [ 8, %concatenate.pivot.8.3 ]
  %10 = sub nsw i32 %3, %9
  %constant_16_2 = load double, ptr @0, align 8
  br label %concatenate.merge

concatenate.pivot.4.:                             ; preds = %input_slice_fusion.in_bounds-true
  %11 = icmp ult i32 %3, 4
  br i1 %11, label %concatenate.pivot.0., label %concatenate.pivot.8.
...
concatenate.pivot.8.:                             ; preds = %concatenate.pivot.4.
  %12 = icmp ult i32 %3, 8
  br i1 %12, label %concatenate.pivot.4.2, label %concatenate.pivot.8.3

concatenate.pivot.4.2:                            ; preds = %concatenate.pivot.8.
  br label %concat_index_from_operand_id1

concatenate.pivot.8.3:                            ; preds = %concatenate.pivot.8.
...
slice0-true:                                      ; preds = %concatenate.merge
  %23 = sub i32 %3, 0
  %24 = getelementptr inbounds [4 x double], ptr %arg0, i32 0, i32 %23
  store double %13, ptr %24, align 8
  br label %slice0-after

slice1-true:                                      ; preds = %slice0-after
  %25 = sub i32 %3, 4
  %26 = getelementptr inbounds [4 x double], ptr %arg1, i32 0, i32 %25
  store double %13, ptr %26, align 8
  br label %slice1-after

slice2-true:                                      ; preds = %slice1-after
  %27 = sub i32 %3, 8
  %28 = getelementptr inbounds [4 x double], ptr %arg2, i32 0, i32 %27
