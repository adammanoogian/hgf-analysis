...
define void @wrapped_iota(ptr noalias align 128 dereferenceable(80) %arg0) {
entry:
  ...
  br i1 %4, label %wrapped_iota.in_bounds-true, label %wrapped_iota.in_bounds-after

wrapped_iota.in_bounds-after:                     ; preds = %wrapped_iota.in_bounds-true, %entry
  ret void

wrapped_iota.in_bounds-true:                      ; preds = %entry
  %5 = zext i32 %linear_index0 to i64
  %6 = getelementptr i64, ptr %arg0, i32 %linear_index
