...
define void @input_multiply_reduce_fusion(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 16 dereferenceable(384) %arg2, ptr noalias align 128 dereferenceable(384) %arg3, ptr noalias align 128 dereferenceable(73728) %arg4) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer32)
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %result_from_other_lane33, ptr %return_buffer35)
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %result_from_other_lane36, ptr %return_buffer38)
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %result_from_other_lane39, ptr %return_buffer41)
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %result_from_other_lane42, ptr %return_buffer44)
...
loop3.loop_body:                                  ; preds = %loop3.loop_header
  ...
  %param_0.7 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %82, i32 %79
  %param_0.73 = load double, ptr %param_0.7, align 8, !invariant.load !7
  %param_1.5 = getelementptr inbounds [48 x [192 x double]], ptr %arg1, i32 0, i32 %82, i32 %79
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
  ...
  %param_2.3 = getelementptr inbounds [48 x [1 x double]], ptr %arg2, i32 0, i32 %93, i32 0
  %param_2.35 = load double, ptr %param_2.3, align 8, !invariant.load !7
  %param_0.76 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %93, i32 %90
  ...
  %107 = getelementptr inbounds [48 x [192 x double]], ptr %arg4, i32 0, i32 %103, i32 %100
...
loop3.loop_body16:                                ; preds = %loop3.loop_header15
  ...
  %param_0.720 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %122, i32 %119
  %param_0.721 = load double, ptr %param_0.720, align 8, !invariant.load !7
  %param_1.522 = getelementptr inbounds [48 x [192 x double]], ptr %arg1, i32 0, i32 %122, i32 %119
  ...
  call void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer25)
  ...
  %param_2.326 = getelementptr inbounds [48 x [1 x double]], ptr %arg2, i32 0, i32 %133, i32 0
  %param_2.327 = load double, ptr %param_2.326, align 8, !invariant.load !7
  %param_0.728 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %133, i32 %130
  ...
  %147 = getelementptr inbounds [48 x [192 x double]], ptr %arg4, i32 0, i32 %143, i32 %140
...
intra_warp_reduce_write-true:                     ; preds = %thread_in_bounds-true
  ...
  %151 = getelementptr inbounds [8 x [1 x double]], ptr addrspace(3) @shared_cache, i32 0, i32 %thread.id.1, i32 %67
...
inter_warp_reduce-true:                           ; preds = %intra_warp_reduce_write-after
  %153 = getelementptr inbounds [8 x [1 x double]], ptr addrspace(3) @shared_cache, i32 0, i32 %thread.id.1, i32 %lane_id
...
reduction_write_output-true:                      ; preds = %inter_warp_reduce-true
  ...
  %output_element_address = getelementptr inbounds [48 x double], ptr %arg3, i32 0, i32 %158
...
define internal void @region_0_10_5588a02a6830_e5fc45201259cab2(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
