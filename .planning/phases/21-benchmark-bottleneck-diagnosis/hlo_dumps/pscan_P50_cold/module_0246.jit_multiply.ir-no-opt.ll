...
define void @loop_multiply_fusion(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 16 dereferenceable(384) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2) {
entry:
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  %7 = getelementptr inbounds [48 x double], ptr %arg1, i32 0, i32 %5
