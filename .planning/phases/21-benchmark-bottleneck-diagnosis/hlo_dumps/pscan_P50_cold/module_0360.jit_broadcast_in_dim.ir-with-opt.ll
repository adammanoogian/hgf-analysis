...
define void @wrapped_broadcast(ptr noalias nocapture readonly align 16 dereferenceable(384) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(768) %arg1) local_unnamed_addr #0 {
entry:
  %arg13 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %arg01 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !3
  %1 = mul nuw nsw i32 %0, 48
  %2 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !4
  %linear_index = add nuw nsw i32 %1, %2
  %3 = zext nneg i32 %2 to i64
  %4 = getelementptr inbounds [48 x double], ptr addrspace(1) %arg01, i64 0, i64 %3
