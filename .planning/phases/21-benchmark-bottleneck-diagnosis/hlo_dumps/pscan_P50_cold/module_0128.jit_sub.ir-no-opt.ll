...
define void @loop_subtract_fusion(ptr noalias align 16 dereferenceable(384) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(384) %arg2) {
entry:
...
!1 = !{ptr @loop_subtract_fusion, !"reqntidx", i32 48}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 48}
!4 = !{}
