...
define void @wrapped_convert(ptr noalias align 16 dereferenceable(36864) %arg0, ptr noalias align 128 dereferenceable(73728) %arg1) {
entry:
...
wrapped_convert.in_bounds-true:                   ; preds = %entry
  %7 = getelementptr float, ptr %arg0, i32 %linear_index
  %8 = getelementptr inbounds float, ptr %7, i32 0
