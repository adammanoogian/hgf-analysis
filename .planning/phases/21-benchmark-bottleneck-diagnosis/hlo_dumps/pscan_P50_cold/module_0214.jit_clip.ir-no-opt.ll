...
define void @loop_divide_minimum_fusion(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 16 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(73728) %arg3, ptr noalias align 128 dereferenceable(73728) %arg4, ptr noalias align 128 dereferenceable(73728) %arg5) {
entry:
  ...
  %6 = icmp ult i32 %linear_index, 9216
...
loop_divide_minimum_fusion.in_bounds-true:        ; preds = %entry
  %7 = load double, ptr %arg2, align 8, !invariant.load !4
  ...
  %16 = load double, ptr %arg0, align 8, !invariant.load !4
  ...
  %constant_8_2 = load double, ptr @0, align 8
  %constant_6_1 = load double, ptr @2, align 8
  %23 = trunc i8 %22 to i1
  %24 = select i1 %23, double %constant_8_2, double %constant_6_1
  %compare.7.1 = fcmp oeq double %16, %minimum.1.1.clone.1
  %25 = zext i1 %compare.7.1 to i8
  %constant_4_1 = load double, ptr @1, align 8
  %26 = trunc i8 %25 to i1
  %27 = select i1 %26, double %constant_4_1, double %constant_8_2
