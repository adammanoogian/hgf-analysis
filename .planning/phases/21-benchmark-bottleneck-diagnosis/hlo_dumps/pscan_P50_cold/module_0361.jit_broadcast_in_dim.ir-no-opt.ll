...
define void @wrapped_broadcast(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 128 dereferenceable(2304) %arg1) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !2
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !3
  %2 = mul nuw nsw i32 %0, 288
  %linear_index = add nuw nsw i32 %2, %1
  %linear_index_in_range = icmp ult i32 %linear_index, 288
...
wrapped_broadcast.in_bounds-true:                 ; preds = %entry
  %5 = load double, ptr %arg0, align 8, !invariant.load !4
...
!1 = !{ptr @wrapped_broadcast, !"reqntidx", i32 288}
!2 = !{i32 0, i32 1}
!3 = !{i32 0, i32 288}
!4 = !{}
