...
entry:
  ...
  %2 = urem i32 %1, 2
  %3 = udiv i32 %block.id.x, 2
  %4 = urem i32 %3, 6
  %5 = udiv i32 %block.id.x, 12
  %6 = icmp eq i32 %2, 1
  %tile_bound.2 = select i1 %6, i32 16, i32 32
...
loop2.loop_body:                                  ; preds = %loop2.loop_header
  ...
  %param_1.1 = getelementptr inbounds [192 x [48 x double]], ptr %arg1, i32 0, i32 %10, i32 %11
  %param_1.12 = load double, ptr %param_1.1, align 8, !invariant.load !4
  ...
  store double %param_1.12, ptr %13, align 8
...
loop2.loop_body11:                                ; preds = %loop2.loop_header10
  ...
  %param_0.1 = getelementptr inbounds [48 x [192 x double]], ptr %arg0, i32 0, i32 %17, i32 %18
  %param_0.115 = load double, ptr %param_0.1, align 8, !invariant.load !4
  %multiply.1.1 = fmul double %21, %param_0.115
  %22 = getelementptr inbounds [48 x [192 x double]], ptr %arg2, i32 0, i32 %17, i32 %18
  store double %multiply.1.1, ptr %22, align 8
