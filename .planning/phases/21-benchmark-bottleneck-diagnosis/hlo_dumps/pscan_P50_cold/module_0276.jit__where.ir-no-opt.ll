...
define void @loop_select_fusion(ptr noalias align 16 dereferenceable(9216) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 16 dereferenceable(8) %arg2, ptr noalias align 128 dereferenceable(73728) %arg3) {
entry:
...
define void @loop_broadcast_fusion(ptr noalias align 128 dereferenceable(73728) %arg0) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !4
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !5
  %2 = mul nuw nsw i32 %0, 1024
