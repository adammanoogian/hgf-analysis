...
define void @wrapped_negate(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg1) local_unnamed_addr #0 {
entry:
