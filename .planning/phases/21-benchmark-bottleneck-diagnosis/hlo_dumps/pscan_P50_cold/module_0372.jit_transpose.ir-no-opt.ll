...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(7680) %arg0, ptr noalias align 128 dereferenceable(7680) %arg1) {
entry:
  ...
  %6 = urem i32 %5, 10
  %7 = udiv i32 %linear_index0, 480
  %8 = icmp ult i32 %linear_index, 960
...
wrapped_transpose.in_bounds-true:                 ; preds = %entry
  %9 = getelementptr inbounds [10 x [2 x [48 x double]]], ptr %arg0, i32 0, i32 %6, i32 %7, i32 %4
