...
define void @loop_add_fusion(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(384) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %8 = getelementptr inbounds [48 x double], ptr addrspace(1) %arg13, i64 0, i64 %7
