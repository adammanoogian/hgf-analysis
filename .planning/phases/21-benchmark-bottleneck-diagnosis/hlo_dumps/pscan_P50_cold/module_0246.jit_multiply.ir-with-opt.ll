...
define void @loop_multiply_fusion(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(384) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(73728) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %5 = getelementptr inbounds [48 x double], ptr addrspace(1) %arg13, i64 0, i64 %4
  ...
  %multiply.1.1 = fmul double %6, %9
  %10 = getelementptr double, ptr addrspace(1) %arg25, i64 %7
  store double %multiply.1.1, ptr addrspace(1) %10, align 8
  ret void
}
