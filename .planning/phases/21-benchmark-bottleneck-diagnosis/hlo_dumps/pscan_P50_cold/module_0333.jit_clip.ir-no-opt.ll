...
define void @loop_multiply_fusion(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 16 dereferenceable(73728) %arg1, ptr noalias align 16 dereferenceable(73728) %arg2, ptr noalias align 128 dereferenceable(73728) %arg3) {
entry:
...
loop_multiply_fusion.in_bounds-true:              ; preds = %entry
  ...
  %multiply.3.1 = fmul double %multiply.2.1, %15
