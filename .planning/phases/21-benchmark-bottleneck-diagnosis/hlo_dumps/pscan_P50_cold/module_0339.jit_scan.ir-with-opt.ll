...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_dynamic_slice_fusion_6(ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(48) %arg2) local_unnamed_addr #0 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_add_fusion(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg2, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg4, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg5, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg6, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg7, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg8, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg9, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg10, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg11, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg12, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg13, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg14, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg15, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg16, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg17, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg18, ptr noalias nocapture readonly align 16 dereferenceable(36864) %arg19, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg20, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg21, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg22, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg23, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg24) local_unnamed_addr #0 {
entry:
  ...
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !28
  %1 = load i64, ptr addrspace(1) %arg936, align 128, !invariant.load !27
  %2 = sub i64 191, %1
  %3 = icmp slt i64 %2, 0
  %4 = sub i64 383, %1
  %5 = select i1 %3, i64 %4, i64 %2
  ...
  %9 = zext nneg i32 %8 to i64
  %10 = zext nneg i32 %0 to i64
  %11 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg528, i64 0, i64 %9, i64 %10
  %12 = load i8, ptr addrspace(1) %11, align 1, !invariant.load !27
  %13 = getelementptr double, ptr addrspace(1) %arg222, i64 %10
  ...
  %17 = getelementptr double, ptr addrspace(1) %arg2364, i64 %10
  %18 = load double, ptr addrspace(1) %17, align 8, !invariant.load !27
  %19 = select i1 %15, double %18, double 0.000000e+00
  %20 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg2262, i64 0, i64 %9, i64 %10
  %21 = load i8, ptr addrspace(1) %20, align 1, !invariant.load !27
  %22 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2160, i64 0, i64 %9, i64 %10
  %23 = load double, ptr addrspace(1) %22, align 8, !invariant.load !27
  %24 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg2058, i64 0, i64 %9, i64 %10
  %25 = load i8, ptr addrspace(1) %24, align 1, !invariant.load !27
  %26 = getelementptr inbounds [192 x [48 x i32]], ptr addrspace(1) %arg1956, i64 0, i64 %9, i64 %10
  %27 = load i32, ptr addrspace(1) %26, align 4, !invariant.load !27
  %28 = icmp eq i32 %27, 1
  %29 = getelementptr double, ptr addrspace(1) %arg1854, i64 %10
  ...
  %35 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1752, i64 0, i64 %9, i64 %10
  %36 = load double, ptr addrspace(1) %35, align 8, !invariant.load !27
  %multiply.375.11 = fmul double %36, %34
  %37 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1650, i64 0, i64 %9, i64 %10
  ...
  %42 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1548, i64 0, i64 %9, i64 %10
  %43 = load double, ptr addrspace(1) %42, align 8, !invariant.load !27
  %44 = getelementptr double, ptr addrspace(1) %arg1446, i64 %10
  %45 = load double, ptr addrspace(1) %44, align 8, !invariant.load !27
  %46 = select i1 %15, double %45, double 0.000000e+00
  %47 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1344, i64 0, i64 %9, i64 %10
  %48 = load double, ptr addrspace(1) %47, align 8, !invariant.load !27
  %multiply.378.17 = fmul double %46, %48
  %49 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1242, i64 0, i64 %9, i64 %10
  ...
  %51 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg324, i64 0, i64 %9, i64 %10
  %52 = load double, ptr addrspace(1) %51, align 8, !invariant.load !27
  %53 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg120, i64 0, i64 %9, i64 %10
  %54 = load double, ptr addrspace(1) %53, align 8, !invariant.load !27
  %55 = fneg double %add.243.5
  %56 = fmul double %52, %55
  %57 = fmul double %54, %56
  %add.244.3 = fadd double %16, %57
  %58 = getelementptr double, ptr addrspace(1) %arg732, i64 %10
  %59 = load double, ptr addrspace(1) %58, align 8, !invariant.load !27
  %60 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg834, i64 0, i64 %9, i64 %10
  %61 = load double, ptr addrspace(1) %60, align 8, !invariant.load !27
  %add.240.3 = fadd double %59, %61
  %62 = select i1 %15, double %add.240.3, double 0.000000e+00
  %63 = getelementptr double, ptr addrspace(1) %arg1140, i64 %10
  ...
  %66 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1038, i64 0, i64 %9, i64 %10
  ...
  %68 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg630, i64 0, i64 %9, i64 %10
  %69 = load double, ptr addrspace(1) %68, align 8, !invariant.load !27
  %70 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg426, i64 0, i64 %9, i64 %10
  %71 = load double, ptr addrspace(1) %70, align 8, !invariant.load !27
  %72 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg018, i64 0, i64 %9, i64 %10
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_dynamic_slice_fusion_5(ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg2) local_unnamed_addr #0 {
entry:
  %arg26 = addrspacecast ptr %arg2 to ptr addrspace(1)
  %arg14 = addrspacecast ptr %arg1 to ptr addrspace(1)
  %arg02 = addrspacecast ptr %arg0 to ptr addrspace(1)
...
define void @loop_broadcast_fusion_1(ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg0) local_unnamed_addr #2 {
entry:
  %arg01 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !28
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write)
define void @loop_broadcast_fusion(ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg0) local_unnamed_addr #2 {
entry:
  %arg01 = addrspacecast ptr %arg0 to ptr addrspace(1)
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !28
  %1 = zext nneg i32 %0 to i64
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_multiply_negate_fusion(ptr noalias nocapture readonly align 128 dereferenceable(384) %arg0, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg2, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg3, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg4, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg5, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg6, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg7, ptr noalias nocapture writeonly align 128 dereferenceable(384) %arg8) local_unnamed_addr #0 {
entry:
  ...
  %9 = fneg double %6
  %10 = fmul double %8, %9
  %multiply.370.3.clone.1 = fmul double %4, %10
  %11 = getelementptr double, ptr addrspace(1) %arg13, i64 %1
  %12 = load double, ptr addrspace(1) %11, align 8, !invariant.load !27
  %multiply.371.1.clone.1 = fmul double %12, %multiply.370.3.clone.1
...
entry:
  ...
  %multiply.373.3 = fmul double %9, %10
  %multiply.374.1 = fmul double %3, %multiply.373.3
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_add_select_fusion(ptr noalias nocapture align 128 dereferenceable(384) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg1, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg2, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg4, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg5, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg6, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg7, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg8, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg9, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg10, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg11, ptr noalias nocapture align 128 dereferenceable(384) %arg12, ptr noalias nocapture align 128 dereferenceable(384) %arg13, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg14, ptr noalias nocapture readonly align 16 dereferenceable(1536) %arg15, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg16, ptr noalias nocapture readonly align 16 dereferenceable(1536) %arg17, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg18, ptr noalias nocapture align 128 dereferenceable(384) %arg19, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg20, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg21, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg22, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg23, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg24, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg25, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg26, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg27, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg28, ptr noalias nocapture readonly align 16 dereferenceable(36864) %arg29, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg30, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg31, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg32, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg33, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg34, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg35, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg36, ptr noalias nocapture align 128 dereferenceable(384) %arg37, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg38) local_unnamed_addr #0 {
entry:
  ...
  %9 = zext nneg i32 %8 to i64
  %10 = zext nneg i32 %0 to i64
  %11 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg127, i64 0, i64 %9, i64 %10
  %12 = load i8, ptr addrspace(1) %11, align 1, !invariant.load !27
  ...
  %19 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg38101, i64 0, i64 %9, i64 %10
  ...
  %23 = load double, ptr addrspace(1) %22, align 8, !invariant.load !27
  %24 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg3697, i64 0, i64 %9, i64 %10
  ...
  %30 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg3493, i64 0, i64 %9, i64 %10
  ...
  %35 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg3289, i64 0, i64 %9, i64 %10
  %36 = load i8, ptr addrspace(1) %35, align 1, !invariant.load !27
  %37 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg3187, i64 0, i64 %9, i64 %10
  %38 = load double, ptr addrspace(1) %37, align 8, !invariant.load !27
  %39 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg3085, i64 0, i64 %9, i64 %10
  %40 = load i8, ptr addrspace(1) %39, align 1, !invariant.load !27
  %41 = getelementptr inbounds [192 x [48 x i32]], ptr addrspace(1) %arg2983, i64 0, i64 %9, i64 %10
  ...
  %50 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2779, i64 0, i64 %9, i64 %10
  %51 = load double, ptr addrspace(1) %50, align 8, !invariant.load !27
  %multiply.375.9.clone.1 = fmul double %51, %49
  %52 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2677, i64 0, i64 %9, i64 %10
  ...
  %57 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2575, i64 0, i64 %9, i64 %10
  ...
  %62 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2371, i64 0, i64 %9, i64 %10
  %63 = load double, ptr addrspace(1) %62, align 8, !invariant.load !27
  %multiply.378.15.clone.1 = fmul double %61, %63
  %64 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2269, i64 0, i64 %9, i64 %10
  ...
  %66 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2167, i64 0, i64 %9, i64 %10
  %67 = load double, ptr addrspace(1) %66, align 8, !invariant.load !27
  ...
  %add.251.5.clone.1 = fadd double %23, %71
  ...
  %75 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1861, i64 0, i64 %9, i64 %10
  %76 = load double, ptr addrspace(1) %75, align 8, !invariant.load !27
  %multiply.397.7.clone.1 = fmul double %76, %add.246.3.clone.1
  ...
  %multiply.398.9.clone.1 = fmul double %78, %multiply.397.7.clone.1
  %add.252.7.clone.1 = fadd double %23, %multiply.398.9.clone.1
  %add.253.5.clone.1 = fadd double %74, %add.252.7.clone.1
  %79 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1657, i64 0, i64 %9, i64 %10
  ...
  %83 = fneg double %add.253.5.clone.1
  %84 = fdiv double %83, %80
  %85 = fmul double %82, %84
  %add.254.5.clone.1 = fadd double %add.251.5.clone.1, %85
  %86 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1453, i64 0, i64 %9, i64 %10
  ...
  %add.255.11.clone.1 = select i1 %15, double %92, double 0.000000e+00
  %93 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1147, i64 0, i64 %9, i64 %10
  %94 = load double, ptr addrspace(1) %93, align 8, !invariant.load !27
  %95 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1045, i64 0, i64 %9, i64 %10
  %96 = load double, ptr addrspace(1) %95, align 8, !invariant.load !27
  %multiply.394.3.clone.1 = fmul double %add.246.3.clone.1, %96
  %97 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg943, i64 0, i64 %9, i64 %10
  %98 = load double, ptr addrspace(1) %97, align 8, !invariant.load !27
  %divide.19.7.clone.1 = fdiv double %multiply.394.3.clone.1, %98
  %multiply.400.9.clone.1 = fmul double %94, %divide.19.7.clone.1
  %99 = getelementptr double, ptr addrspace(1) %arg841, i64 %10
  %100 = load double, ptr addrspace(1) %99, align 8, !invariant.load !27
  %add.256.7.clone.1 = fadd double %100, %multiply.400.9.clone.1
  %add.257.9.clone.1 = fadd double %add.255.11.clone.1, %add.256.7.clone.1
  %add.258.7.clone.1 = fadd double %23, %add.257.9.clone.1
  %101 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg739, i64 0, i64 %9, i64 %10
  %102 = load double, ptr addrspace(1) %101, align 8, !invariant.load !27
  %103 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg637, i64 0, i64 %9, i64 %10
  %104 = load double, ptr addrspace(1) %103, align 8, !invariant.load !27
  %105 = fmul double %102, %83
  %106 = fmul double %105, %104
  %add.259.5.clone.1 = fadd double %106, %add.258.7.clone.1
  %107 = fmul double %87, %add.259.5.clone.1
  %add.260.7.clone.1 = fsub double %add.254.5.clone.1, %107
  %108 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg535, i64 0, i64 %9, i64 %10
  %109 = load double, ptr addrspace(1) %108, align 8, !invariant.load !27
  %multiply.404.5.clone.1 = fmul double %109, %add.259.5.clone.1
  %add.261.5.clone.1 = fadd double %multiply.404.5.clone.1, %add.260.7.clone.1
  %110 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg433, i64 0, i64 %9, i64 %10
  %111 = load double, ptr addrspace(1) %110, align 8, !invariant.load !27
  %multiply.405.3.clone.1 = fmul double %111, %add.261.5.clone.1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite)
define void @loop_add_select_fusion_1(ptr noalias nocapture align 128 dereferenceable(384) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg2, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg3, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg4, ptr noalias nocapture align 128 dereferenceable(384) %arg5, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg6, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg7, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg8, ptr noalias nocapture readonly align 16 dereferenceable(36864) %arg9, ptr noalias nocapture readonly align 128 dereferenceable(8) %arg10, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg11, ptr noalias nocapture align 128 dereferenceable(384) %arg12, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg13, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg14, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg15, ptr noalias nocapture align 128 dereferenceable(384) %arg16, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg17, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg18, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg19, ptr noalias nocapture align 128 dereferenceable(384) %arg20, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg21, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg22, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg23, ptr noalias nocapture readonly align 16 dereferenceable(1536) %arg24, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg25, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg26, ptr noalias nocapture align 128 dereferenceable(384) %arg27, ptr noalias nocapture align 128 dereferenceable(384) %arg28, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg29, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg30, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg31, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg32, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg33, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg34, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg35, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg36, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg37, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg38, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg39, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg40, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg41, ptr noalias nocapture align 128 dereferenceable(384) %arg42, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg43, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg44, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg45, ptr noalias nocapture align 128 dereferenceable(384) %arg46, ptr noalias nocapture align 128 dereferenceable(384) %arg47, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg48, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg49, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg50, ptr noalias nocapture align 128 dereferenceable(384) %arg51, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg52, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg53, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg54, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg55, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg56, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg57, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg58, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg59, ptr noalias nocapture align 128 dereferenceable(384) %arg60, ptr noalias nocapture align 128 dereferenceable(384) %arg61, ptr noalias nocapture readonly align 128 dereferenceable(384) %arg62, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg63, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg64, ptr noalias nocapture readonly align 16 dereferenceable(73728) %arg65, ptr noalias nocapture readonly align 16 dereferenceable(9216) %arg66, ptr noalias nocapture align 128 dereferenceable(384) %arg67, ptr noalias nocapture readnone align 16 dereferenceable(9216) %arg68, ptr noalias nocapture align 128 dereferenceable(384) %arg69, ptr noalias nocapture align 128 dereferenceable(384) %arg70) local_unnamed_addr #0 {
entry:
  ...
  %0 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !28
  %1 = load i64, ptr addrspace(1) %arg1071, align 128, !invariant.load !27
  %2 = sub i64 191, %1
  %3 = icmp slt i64 %2, 0
  %4 = sub i64 383, %1
  %5 = select i1 %3, i64 %4, i64 %2
  ...
  %9 = zext nneg i32 %8 to i64
  %10 = zext nneg i32 %0 to i64
  %11 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg765, i64 0, i64 %9, i64 %10
  %12 = load i8, ptr addrspace(1) %11, align 1, !invariant.load !27
  %13 = getelementptr double, ptr addrspace(1) %arg051, i64 %10
  %14 = load double, ptr addrspace(1) %13, align 8
  %15 = trunc i8 %12 to i1
  %16 = select i1 %15, double 0.000000e+00, double %14
  %17 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg663, i64 0, i64 %9, i64 %10
  %18 = load i8, ptr addrspace(1) %17, align 1, !invariant.load !27
  %19 = getelementptr inbounds [192 x [48 x i32]], ptr addrspace(1) %arg969, i64 0, i64 %9, i64 %10
  %20 = load i32, ptr addrspace(1) %19, align 4, !invariant.load !27
  %21 = icmp eq i32 %20, 0
  %22 = select i1 %15, double %14, double 0.000000e+00
  %23 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg867, i64 0, i64 %9, i64 %10
  %24 = load double, ptr addrspace(1) %23, align 8, !invariant.load !27
  %.neg = fneg double %22
  %25 = select i1 %21, double %.neg, double -0.000000e+00
  %26 = fmul double %24, %25
  %27 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg459, i64 0, i64 %9, i64 %10
  %28 = load double, ptr addrspace(1) %27, align 8, !invariant.load !27
  %29 = fneg double %26
  %30 = fmul double %28, %29
  %31 = trunc i8 %18 to i1
  %32 = select i1 %31, double %30, double 0.000000e+00
  %33 = getelementptr double, ptr addrspace(1) %arg357, i64 %10
  %34 = load double, ptr addrspace(1) %33, align 8, !invariant.load !27
  %add.289.3 = fadd double %34, %32
  %35 = getelementptr double, ptr addrspace(1) %arg2091, i64 %10
  %36 = load double, ptr addrspace(1) %35, align 8
  %37 = select i1 %15, double %36, double 0.000000e+00
  %38 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg1989, i64 0, i64 %9, i64 %10
  %39 = load i8, ptr addrspace(1) %38, align 1, !invariant.load !27
  %40 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg1887, i64 0, i64 %9, i64 %10
  ...
  %48 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1785, i64 0, i64 %9, i64 %10
  %49 = load double, ptr addrspace(1) %48, align 8, !invariant.load !27
  %50 = getelementptr double, ptr addrspace(1) %arg1683, i64 %10
  %51 = load double, ptr addrspace(1) %50, align 8
  %52 = select i1 %15, double %51, double 0.000000e+00
  %53 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1581, i64 0, i64 %9, i64 %10
  %54 = load double, ptr addrspace(1) %53, align 8, !invariant.load !27
  %multiply.378.13 = fmul double %52, %54
  %55 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1479, i64 0, i64 %9, i64 %10
  ...
  %60 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1377, i64 0, i64 %9, i64 %10
  %61 = load double, ptr addrspace(1) %60, align 8, !invariant.load !27
  %62 = getelementptr double, ptr addrspace(1) %arg1275, i64 %10
  %63 = load double, ptr addrspace(1) %62, align 8
  %64 = select i1 %15, double %63, double 0.000000e+00
  %add.293.9 = fadd double %34, %64
  %multiply.432.7 = fmul double %61, %add.293.9
  %add.294.7 = fadd double %multiply.432.7, %add.292.9
  %65 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg1173, i64 0, i64 %9, i64 %10
  %66 = load double, ptr addrspace(1) %65, align 8, !invariant.load !27
  %67 = fneg double %add.294.7
  %68 = fmul double %66, %67
  %69 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg255, i64 0, i64 %9, i64 %10
  %70 = load double, ptr addrspace(1) %69, align 8, !invariant.load !27
  %71 = getelementptr double, ptr addrspace(1) %arg561, i64 %10
  %72 = load double, ptr addrspace(1) %71, align 8
  %73 = select i1 %15, double %72, double 0.000000e+00
  %add.296.3 = fadd double %34, %73
  %74 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg153, i64 0, i64 %9, i64 %10
  %75 = load double, ptr addrspace(1) %74, align 8, !invariant.load !27
  %76 = fneg double %add.296.3
  %77 = fmul double %75, %76
  %78 = fmul double %70, %68
  %add.297.5 = fsub double %77, %78
  ...
  %81 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg26103, i64 0, i64 %9, i64 %10
  %82 = load double, ptr addrspace(1) %81, align 8, !invariant.load !27
  %multiply.436.5.clone.1 = fmul double %26, %82
  %83 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg25101, i64 0, i64 %9, i64 %10
  ...
  %87 = load double, ptr addrspace(1) %86, align 8, !invariant.load !27
  %88 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg2397, i64 0, i64 %9, i64 %10
  %89 = load i8, ptr addrspace(1) %88, align 1, !invariant.load !27
  %90 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2295, i64 0, i64 %9, i64 %10
  ...
  %94 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg2193, i64 0, i64 %9, i64 %10
  ...
  %102 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg44139, i64 0, i64 %9, i64 %10
  %103 = load double, ptr addrspace(1) %102, align 8, !invariant.load !27
  %104 = getelementptr inbounds [192 x [48 x i8]], ptr addrspace(1) %arg43137, i64 0, i64 %9, i64 %10
  ...
  %112 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg59169, i64 0, i64 %9, i64 %10
  %113 = load double, ptr addrspace(1) %112, align 8, !invariant.load !27
  %114 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg40131, i64 0, i64 %9, i64 %10
  ...
  %117 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg58167, i64 0, i64 %9, i64 %10
  ...
  %add.241.9.clone.1 = fsub double %multiply.377.9.clone.1, %119
  %120 = select i1 %46, double %add.241.9.clone.1, double 0.000000e+00
  %121 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg57165, i64 0, i64 %9, i64 %10
  %122 = load double, ptr addrspace(1) %121, align 8, !invariant.load !27
  %123 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg34119, i64 0, i64 %9, i64 %10
  %124 = load double, ptr addrspace(1) %123, align 8, !invariant.load !27
  %multiply.379.15.clone.1 = fmul double %multiply.378.13, %124
  %multiply.380.9.clone.1 = fmul double %122, %multiply.379.15.clone.1
  %add.242.9.clone.1 = fadd double %120, %multiply.380.9.clone.1
  %add.243.7.clone.1 = fadd double %111, %add.242.9.clone.1
  %125 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg56163, i64 0, i64 %9, i64 %10
  %126 = load double, ptr addrspace(1) %125, align 8, !invariant.load !27
  %multiply.407.3.clone.1 = fmul double %126, %add.243.7.clone.1
  %127 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg55161, i64 0, i64 %9, i64 %10
  ...
  %add.266.7.clone.1 = fadd double %108, %add.265.3.clone.1
  %129 = getelementptr double, ptr addrspace(1) %arg54159, i64 %10
  %130 = load double, ptr addrspace(1) %129, align 8, !invariant.load !27
  %add.267.5.clone.1 = fadd double %130, %add.266.7.clone.1
  %131 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg53157, i64 0, i64 %9, i64 %10
  ...
  %136 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg41133, i64 0, i64 %9, i64 %10
  %137 = load double, ptr addrspace(1) %136, align 8, !invariant.load !27
  %138 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg39129, i64 0, i64 %9, i64 %10
  %139 = load double, ptr addrspace(1) %138, align 8, !invariant.load !27
  %multiply.408.9.clone.1 = fmul double %139, %116
  %multiply.409.11.clone.1 = fmul double %137, %multiply.408.9.clone.1
  %140 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg38127, i64 0, i64 %9, i64 %10
  ...
  %142 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg37125, i64 0, i64 %9, i64 %10
  ...
  %144 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg36123, i64 0, i64 %9, i64 %10
  ...
  %146 = select i1 %46, double %add.269.7.clone.1, double 0.000000e+00
  %147 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg35121, i64 0, i64 %9, i64 %10
  %148 = load double, ptr addrspace(1) %147, align 8, !invariant.load !27
  %149 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg33117, i64 0, i64 %9, i64 %10
  %150 = load double, ptr addrspace(1) %149, align 8, !invariant.load !27
  %multiply.416.9.clone.1 = fmul double %multiply.379.15.clone.1, %150
  ...
  %151 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg52155, i64 0, i64 %9, i64 %10
  %152 = load double, ptr addrspace(1) %151, align 8, !invariant.load !27
  %153 = fneg double %add.273.3.clone.1
  %154 = fmul double %152, %153
  %155 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg32115, i64 0, i64 %9, i64 %10
  %156 = load double, ptr addrspace(1) %155, align 8, !invariant.load !27
  %multiply.422.7.clone.1.clone.1 = fmul double %156, %add.272.5.clone.1
  %add.281.5.clone.1.clone.1 = fadd double %multiply.422.7.clone.1.clone.1, %154
  %157 = trunc i8 %105 to i1
  %158 = select i1 %157, double %add.281.5.clone.1.clone.1, double 0.000000e+00
  %multiply.423.5.clone.1.clone.1 = fmul double %87, %158
  %159 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg31113, i64 0, i64 %9, i64 %10
  ...
  %161 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg29109, i64 0, i64 %9, i64 %10
  ...
  %179 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg50151, i64 0, i64 %9, i64 %10
  ...
  %182 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg49149, i64 0, i64 %9, i64 %10
  ...
  %add.275.5.clone.1 = fsub double %185, %186
  %add.276.3.clone.1 = fadd double %178, %add.275.5.clone.1
  ...
  %190 = getelementptr inbounds [192 x [48 x [1 x i8]]], ptr addrspace(1) %arg66183, i64 0, i64 %9, i64 %10, i64 0
  %191 = load i8, ptr addrspace(1) %190, align 1, !invariant.load !27
  %192 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg65181, i64 0, i64 %9, i64 %10
  %193 = load double, ptr addrspace(1) %192, align 8, !invariant.load !27
  %multiply.441.9.clone.1 = fmul double %multiply.408.9.clone.1, %193
  %multiply.442.9.clone.1 = fmul double %multiply.441.9.clone.1, 5.000000e-01
  %194 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg64179, i64 0, i64 %9, i64 %10
  ...
  %198 = getelementptr inbounds [192 x [48 x double]], ptr addrspace(1) %arg63177, i64 0, i64 %9, i64 %10
