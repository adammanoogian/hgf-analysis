...
define void @wrapped_negate(ptr noalias align 16 dereferenceable(73728) %arg0, ptr noalias align 128 dereferenceable(73728) %arg1) {
entry:
  ...
  br i1 %6, label %wrapped_negate.in_bounds-true, label %wrapped_negate.in_bounds-after
