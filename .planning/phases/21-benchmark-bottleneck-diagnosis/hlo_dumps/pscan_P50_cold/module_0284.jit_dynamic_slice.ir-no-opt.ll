...
define void @loop_dynamic_slice_fusion(ptr noalias align 16 dereferenceable(147456) %arg0, ptr noalias align 16 dereferenceable(8) %arg1, ptr noalias align 128 dereferenceable(73728) %arg2) {
entry:
...
loop_dynamic_slice_fusion.in_bounds-true:         ; preds = %entry
  ...
  %25 = getelementptr inbounds [48 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %22, i32 %23, i32 %24
