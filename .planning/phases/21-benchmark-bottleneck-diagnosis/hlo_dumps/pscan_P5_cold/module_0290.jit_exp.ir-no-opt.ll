...
define void @wrapped_exponential(ptr noalias align 16 dereferenceable(8) %arg0, ptr noalias align 128 dereferenceable(8) %arg1) {
entry:
  ...
  br i1 %3, label %wrapped_exponential.in_bounds-true, label %wrapped_exponential.in_bounds-after
