...
define void @wrapped_concatenate(ptr noalias align 16 dereferenceable(6144) %arg0, ptr noalias align 16 dereferenceable(6144) %arg1, ptr noalias align 128 dereferenceable(12288) %arg2) {
entry:
...
wrapped_concatenate.in_bounds-after:              ; preds = %wrapped_concatenate.in_bounds-true, %entry
  ...
  %17 = icmp ult i32 %linear_index1, 768
...
wrapped_concatenate.in_bounds-true:               ; preds = %entry
  ...
  %22 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg2, i32 0, i32 %7, i32 %6, i32 %18
...
wrapped_concatenate.in_bounds-true4:              ; preds = %wrapped_concatenate.in_bounds-after
  ...
  %27 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg2, i32 0, i32 %16, i32 %15, i32 %23
