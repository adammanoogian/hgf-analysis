...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_3_562488853f80_26448517f7b77068(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
  ...
  call void @region_0_3_562488853f80_26448517f7b77068(ptr %partial_reduction_result, ptr %result_from_other_lane5, ptr %return_buffer7)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  call void @region_0_3_562488853f80_26448517f7b77068(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_3_562488853f80_26448517f7b77068(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
