...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_5570f6578560_6e9d09df056ac8ee(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  call void @region_0_6_5570f6578560_6e9d09df056ac8ee(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_6_5570f6578560_6e9d09df056ac8ee(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  %20 = bitcast i64 %19 to double
  store double %20, ptr %result_from_other_lane, align 8
  call void @region_1_18_5570f6637d40_65940a565a412f4d(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer10)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  call void @region_1_18_5570f6637d40_65940a565a412f4d(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_1_18_5570f6637d40_65940a565a412f4d(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
  %2 = alloca double, align 8
