...
loop1.loop_exit:                                  ; preds = %loop1.loop_header
  ...
  call void @region_0_6_5570f70679e0_65940a565a412f4d(ptr %partial_reduction_result, ptr %result_from_other_lane, ptr %return_buffer4)
...
x_in_tile-true:                                   ; preds = %loop2.loop_body
  ...
  %param_0.10 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr %arg0, i32 0, i32 %33, i32 %32, i32 %28
  ...
  call void @region_0_6_5570f70679e0_65940a565a412f4d(ptr %partial_reduction_result, ptr %reduction_input_address, ptr %return_buffer)
...
define internal void @region_0_6_5570f70679e0_65940a565a412f4d(ptr dereferenceable(8) %0, ptr dereferenceable(8) %1, ptr dereferenceable(8) %output_arg) {
entry:
...
define void @loop_add_fusion(ptr noalias align 16 dereferenceable(12288) %arg0, ptr noalias align 16 dereferenceable(12288) %arg1, ptr noalias align 16 dereferenceable(6144) %arg2, ptr noalias align 128 dereferenceable(6144) %arg3, ptr noalias align 128 dereferenceable(12288) %arg4) {
entry:
