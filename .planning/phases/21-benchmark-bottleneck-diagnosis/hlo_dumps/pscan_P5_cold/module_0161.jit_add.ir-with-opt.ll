...
define void @loop_add_fusion(ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(32) %arg1, ptr noalias nocapture writeonly align 128 dereferenceable(6144) %arg2) local_unnamed_addr #0 {
entry:
  ...
  %8 = getelementptr inbounds [4 x double], ptr addrspace(1) %arg13, i64 0, i64 %7
  %9 = load double, ptr addrspace(1) %8, align 8, !invariant.load !5
  %add.1.1 = fadd double %6, %9
  %10 = getelementptr double, ptr addrspace(1) %arg25, i64 %4
  store double %add.1.1, ptr addrspace(1) %10, align 8
  ret void
}
...
!1 = !{ptr @loop_add_fusion, !"reqntidx", i32 128}
