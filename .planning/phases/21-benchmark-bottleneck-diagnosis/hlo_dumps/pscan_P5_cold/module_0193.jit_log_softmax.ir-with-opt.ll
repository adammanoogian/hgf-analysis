...
entry:
  ...
  %param_0.10 = getelementptr inbounds [4 x [192 x [2 x double]]], ptr addrspace(1) %arg019, i64 0, i64 %5, i64 %6, i64 %1
...
reduction_write_output-true:                      ; preds = %entry
  ...
  store double %add.2.i10, ptr addrspace(1) %output_element_address, align 8
...
define void @loop_add_fusion(ptr noalias nocapture readonly align 16 dereferenceable(12288) %arg0, ptr noalias nocapture readonly align 16 dereferenceable(12288) %arg1, ptr noalias nocapture readonly align 16 dereferenceable(6144) %arg2, ptr noalias nocapture readonly align 128 dereferenceable(6144) %arg3, ptr noalias nocapture writeonly align 128 dereferenceable(12288) %arg4) local_unnamed_addr #3 {
entry:
  ...
  %10 = fneg double %9
  %11 = getelementptr inbounds double, ptr addrspace(1) %arg25, i64 %7
  %12 = load double, ptr addrspace(1) %11, align 8, !invariant.load !7
  %divide.1.3 = fdiv double %10, %12
  %13 = getelementptr double, ptr addrspace(1) %arg13, i64 %4
  %14 = load double, ptr addrspace(1) %13, align 8, !invariant.load !7
  %multiply.1.3 = fmul double %divide.1.3, %14
  %add.3.1 = fadd double %6, %multiply.1.3
  %15 = getelementptr double, ptr addrspace(1) %arg49, i64 %4
  store double %add.3.1, ptr addrspace(1) %15, align 8
  ret void
}
