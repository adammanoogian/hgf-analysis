...
define void @wrapped_transpose(ptr noalias align 16 dereferenceable(640) %arg0, ptr noalias align 128 dereferenceable(640) %arg1) {
entry:
  %0 = call i32 @llvm.nvvm.read.ptx.sreg.ctaid.x(), !range !2
  %1 = call i32 @llvm.nvvm.read.ptx.sreg.tid.x(), !range !3
  %2 = mul nuw nsw i32 %0, 80
  ...
  %6 = urem i32 %5, 10
  %7 = udiv i32 %linear_index0, 40
  %8 = icmp ult i32 %linear_index, 80
  br i1 %8, label %wrapped_transpose.in_bounds-true, label %wrapped_transpose.in_bounds-after
...
wrapped_transpose.in_bounds-true:                 ; preds = %entry
  %9 = getelementptr inbounds [10 x [2 x [4 x double]]], ptr %arg0, i32 0, i32 %6, i32 %7, i32 %4
